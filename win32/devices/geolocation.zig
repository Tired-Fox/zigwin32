...
pub const Location = Guid.initString("e5b8e079-ee6d-4e33-a438-c87f2e959254");
pub const DefaultLocation = Guid.initString("8b7fbfe0-5cd7-494a-af8c-283a65707506");
pub const LatLongReport = Guid.initString("ed81c073-1f84-4ca8-a161-183c776bc651");
pub const CivicAddressReport = Guid.initString("d39e7bdd-7d05-46b8-8721-80cf035f57d7");
pub const LatLongReportFactory = Guid.initString("9dcc3cc8-8609-4863-bad4-03601f4c65e8");
pub const CivicAddressReportFactory = Guid.initString("2a11f42c-3e81-4ad4-9cbe-45579d89671a");
pub const DispLatLongReport = Guid.initString("7a7c3277-8f84-4636-95b2-ebb5507ff77e");
pub const DispCivicAddressReport = Guid.initString("4c596aec-8544-4082-ba9f-eb0a7d8e65c6");
