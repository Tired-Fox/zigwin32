...
pub const FaxServer = Guid.initString("cda8acb0-8cf5-4f6c-9ba2-5931d40c8cae");
pub const FaxDeviceProviders = Guid.initString("eb8fe768-875a-4f5f-82c5-03f23aac1bd7");
pub const FaxDevices = Guid.initString("5589e28e-23cb-4919-8808-e6101846e80d");
pub const FaxInboundRouting = Guid.initString("e80248ed-ad65-4218-8108-991924d4e7ed");
pub const FaxFolders = Guid.initString("c35211d7-5776-48cb-af44-c31be3b2cfe5");
pub const FaxLoggingOptions = Guid.initString("1bf9eea6-ece0-4785-a18b-de56e9eef96a");
pub const FaxActivity = Guid.initString("cfef5d0e-e84d-462e-aabb-87d31eb04fef");
pub const FaxOutboundRouting = Guid.initString("c81b385e-b869-4afd-86c0-616498ed9be2");
pub const FaxReceiptOptions = Guid.initString("6982487b-227b-4c96-a61c-248348b05ab6");
pub const FaxSecurity = Guid.initString("10c4ddde-abf0-43df-964f-7f3ac21a4c7b");
pub const FaxDocument = Guid.initString("0f3f9f91-c838-415e-a4f3-3e828ca445e0");
pub const FaxSender = Guid.initString("265d84d0-1850-4360-b7c8-758bbb5f0b96");
pub const FaxRecipients = Guid.initString("ea9bdf53-10a9-4d4f-a067-63c8f84f01b0");
pub const FaxIncomingArchive = Guid.initString("8426c56a-35a1-4c6f-af93-fc952422e2c2");
pub const FaxIncomingQueue = Guid.initString("69131717-f3f1-40e3-809d-a6cbf7bd85e5");
pub const FaxOutgoingArchive = Guid.initString("43c28403-e04f-474d-990c-b94669148f59");
pub const FaxOutgoingQueue = Guid.initString("7421169e-8c43-4b0d-bb16-645c8fa40357");
pub const FaxIncomingMessageIterator = Guid.initString("6088e1d8-3fc8-45c2-87b1-909a29607ea9");
pub const FaxIncomingMessage = Guid.initString("1932fcf7-9d43-4d5a-89ff-03861b321736");
pub const FaxOutgoingJobs = Guid.initString("92bf2a6c-37be-43fa-a37d-cb0e5f753b35");
pub const FaxOutgoingJob = Guid.initString("71bb429c-0ef9-4915-bec5-a5d897a3e924");
pub const FaxOutgoingMessageIterator = Guid.initString("8a3224d0-d30b-49de-9813-cb385790fbbb");
pub const FaxOutgoingMessage = Guid.initString("91b4a378-4ad8-4aef-a4dc-97d96e939a3a");
pub const FaxIncomingJobs = Guid.initString("a1bb8a43-8866-4fb7-a15d-6266c875a5cc");
pub const FaxIncomingJob = Guid.initString("c47311ec-ae32-41b8-ae4b-3eae0629d0c9");
pub const FaxDeviceProvider = Guid.initString("17cf1aa3-f5eb-484a-9c9a-4440a5baabfc");
pub const FaxDevice = Guid.initString("59e3a5b2-d676-484b-a6de-720bfa89b5af");
pub const FaxActivityLogging = Guid.initString("f0a0294e-3bbd-48b8-8f13-8c591a55bdbc");
pub const FaxEventLogging = Guid.initString("a6850930-a0f6-4a6f-95b7-db2ebf3d02e3");
pub const FaxOutboundRoutingGroups = Guid.initString("ccbea1a5-e2b4-4b57-9421-b04b6289464b");
pub const FaxOutboundRoutingGroup = Guid.initString("0213f3e0-6791-4d77-a271-04d2357c50d6");
pub const FaxDeviceIds = Guid.initString("cdc539ea-7277-460e-8de0-48a0a5760d1f");
pub const FaxOutboundRoutingRules = Guid.initString("d385beca-e624-4473-bfaa-9f4000831f54");
pub const FaxOutboundRoutingRule = Guid.initString("6549eebf-08d1-475a-828b-3bf105952fa0");
pub const FaxInboundRoutingExtensions = Guid.initString("189a48ed-623c-4c0d-80f2-d66c7b9efec2");
pub const FaxInboundRoutingExtension = Guid.initString("1d7dfb51-7207-4436-a0d9-24e32ee56988");
pub const FaxInboundRoutingMethods = Guid.initString("25fcb76a-b750-4b82-9266-fbbbae8922ba");
pub const FaxInboundRoutingMethod = Guid.initString("4b9fd75c-0194-4b72-9ce5-02a8205ac7d4");
pub const FaxJobStatus = Guid.initString("7bf222f4-be8d-442f-841d-6132742423bb");
pub const FaxRecipient = Guid.initString("60bf3301-7df8-4bd8-9148-7b5801f9efdf");
pub const FaxConfiguration = Guid.initString("5857326f-e7b3-41a7-9c19-a91b463e2d56");
pub const FaxAccountSet = Guid.initString("fbc23c4b-79e0-4291-bc56-c12e253bbf3a");
pub const FaxAccounts = Guid.initString("da1f94aa-ee2c-47c0-8f4f-2a217075b76e");
pub const FaxAccount = Guid.initString("a7e0647f-4524-4464-a56d-b9fe666f715e");
pub const FaxAccountFolders = Guid.initString("85398f49-c034-4a3f-821c-db7d685e8129");
pub const FaxAccountIncomingQueue = Guid.initString("9bcf6094-b4da-45f4-b8d6-ddeb2186652c");
pub const FaxAccountOutgoingQueue = Guid.initString("feeceefb-c149-48ba-bab8-b791e101f62f");
pub const FaxAccountIncomingArchive = Guid.initString("14b33db5-4c40-4ecf-9ef8-a360cbe809ed");
pub const FaxAccountOutgoingArchive = Guid.initString("851e7af5-433a-4739-a2df-ad245c2cb98e");
pub const FaxSecurity2 = Guid.initString("735c1248-ec89-4c30-a127-656e92e3c4ea");
