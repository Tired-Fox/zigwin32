...
pub const WpdSerializer = Guid.initString("0b91a74b-ad7c-4a9d-b563-29eef9167172");
pub const PortableDeviceValues = Guid.initString("0c15d503-d017-47ce-9016-7b3f978721cc");
pub const PortableDeviceKeyCollection = Guid.initString("de2d022d-2480-43be-97f0-d1fa2cf98f4f");
pub const PortableDevicePropVariantCollection = Guid.initString("08a99e2f-6d6d-4b80-af5a-baf2bcbe4cb9");
pub const PortableDeviceValuesCollection = Guid.initString("3882134d-14cf-4220-9cb4-435f86d83f60");
pub const PortableDevice = Guid.initString("728a21c5-3d9e-48d7-9810-864848f0f404");
pub const PortableDeviceManager = Guid.initString("0af10cec-2ecd-4b92-9581-34f6ae0637f3");
pub const PortableDeviceService = Guid.initString("ef5db4c2-9312-422c-9152-411cd9c4dd84");
pub const PortableDeviceDispatchFactory = Guid.initString("43232233-8338-4658-ae01-0b4ae830b6b0");
pub const PortableDeviceFTM = Guid.initString("f7c0039a-4762-488a-b4b3-760ef9a1ba9b");
pub const PortableDeviceServiceFTM = Guid.initString("1649b154-c794-497a-9b03-f3f0121302f3");
pub const PortableDeviceWebControl = Guid.initString("186dd02c-2dec-41b5-a7d4-b59056fade51");
pub const EnumBthMtpConnectors = Guid.initString("a1570149-e645-4f43-8b0d-409b061db2fc");
