...
pub const GUID_NULL = Guid.initString("00000000-0000-0000-0000-000000000000");
pub const KSPROPTYPESETID_General = Guid.initString("97e99ba0-bdea-11cf-a5d6-28db04c10000");
pub const KSPROPSETID_General = Guid.initString("1464eda5-6a8f-11d1-9aa7-00a0c9223196");
pub const KSMETHODSETID_StreamIo = Guid.initString("65d003ca-1523-11d2-b27a-00a0c9223196");
pub const KSPROPSETID_MediaSeeking = Guid.initString("ee904f0c-d09b-11d0-abe9-00a0c9223196");
pub const KSPROPSETID_Topology = Guid.initString("720d4ac0-7533-11d0-a5d6-28db04c10000");
pub const KSCATEGORY_BRIDGE = Guid.initString("085aff00-62ce-11cf-a5d6-28db04c10000");
pub const KSCATEGORY_CAPTURE = Guid.initString("65e8773d-8f56-11d0-a3b9-00a0c9223196");
pub const KSCATEGORY_VIDEO_CAMERA = Guid.initString("e5323777-f976-4f5b-9b55-b94699c46e44");
pub const KSCATEGORY_SENSOR_CAMERA = Guid.initString("24e552d7-6523-47f7-a647-d3465bf1f5ca");
pub const KSCATEGORY_NETWORK_CAMERA = Guid.initString("b8238652-b500-41eb-b4f3-4234f7f5ae99");
pub const KSCATEGORY_SENSOR_GROUP = Guid.initString("669c7214-0a88-4311-a7f3-4e79820e33bd");
pub const KSCATEGORY_RENDER = Guid.initString("65e8773e-8f56-11d0-a3b9-00a0c9223196");
pub const KSCATEGORY_MIXER = Guid.initString("ad809c00-7b88-11d0-a5d6-28db04c10000");
pub const KSCATEGORY_SPLITTER = Guid.initString("0a4252a0-7e70-11d0-a5d6-28db04c10000");
pub const KSCATEGORY_DATACOMPRESSOR = Guid.initString("1e84c900-7e70-11d0-a5d6-28db04c10000");
pub const KSCATEGORY_DATADECOMPRESSOR = Guid.initString("2721ae20-7e70-11d0-a5d6-28db04c10000");
pub const KSCATEGORY_DATATRANSFORM = Guid.initString("2eb07ea0-7e70-11d0-a5d6-28db04c10000");
pub const KSMFT_CATEGORY_VIDEO_DECODER = Guid.initString("d6c02d4b-6833-45b4-971a-05a4b04bab91");
pub const KSMFT_CATEGORY_VIDEO_ENCODER = Guid.initString("f79eac7d-e545-4387-bdee-d647d7bde42a");
pub const KSMFT_CATEGORY_VIDEO_EFFECT = Guid.initString("12e17c21-532c-4a6e-8a1c-40825a736397");
pub const KSMFT_CATEGORY_MULTIPLEXER = Guid.initString("059c561e-05ae-4b61-b69d-55b61ee54a7b");
pub const KSMFT_CATEGORY_DEMULTIPLEXER = Guid.initString("a8700a7a-939b-44c5-99d7-76226b23b3f1");
pub const KSMFT_CATEGORY_AUDIO_DECODER = Guid.initString("9ea73fb4-ef7a-4559-8d5d-719d8f0426c7");
pub const KSMFT_CATEGORY_AUDIO_ENCODER = Guid.initString("91c64bd0-f91e-4d8c-9276-db248279d975");
pub const KSMFT_CATEGORY_AUDIO_EFFECT = Guid.initString("11064c48-3648-4ed0-932e-05ce8ac811b7");
pub const KSMFT_CATEGORY_VIDEO_PROCESSOR = Guid.initString("302ea3fc-aa5f-47f9-9f7a-c2188bb16302");
pub const KSMFT_CATEGORY_OTHER = Guid.initString("90175d57-b7ea-4901-aeb3-933a8747756f");
pub const KSCATEGORY_COMMUNICATIONSTRANSFORM = Guid.initString("cf1dda2c-9743-11d0-a3ee-00a0c9223196");
pub const KSCATEGORY_INTERFACETRANSFORM = Guid.initString("cf1dda2d-9743-11d0-a3ee-00a0c9223196");
pub const KSCATEGORY_MEDIUMTRANSFORM = Guid.initString("cf1dda2e-9743-11d0-a3ee-00a0c9223196");
pub const KSCATEGORY_FILESYSTEM = Guid.initString("760fed5e-9357-11d0-a3cc-00a0c9223196");
pub const KSCATEGORY_CLOCK = Guid.initString("53172480-4791-11d0-a5d6-28db04c10000");
pub const KSCATEGORY_PROXY = Guid.initString("97ebaaca-95bd-11d0-a3ea-00a0c9223196");
pub const KSCATEGORY_QUALITY = Guid.initString("97ebaacb-95bd-11d0-a3ea-00a0c9223196");
pub const KSTIME_FORMAT_FRAME = Guid.initString("7b785570-8c82-11cf-bc0c-00aa00ac74f6");
pub const KSTIME_FORMAT_BYTE = Guid.initString("7b785571-8c82-11cf-bc0c-00aa00ac74f6");
pub const KSTIME_FORMAT_SAMPLE = Guid.initString("7b785572-8c82-11cf-bc0c-00aa00ac74f6");
pub const KSTIME_FORMAT_FIELD = Guid.initString("7b785573-8c82-11cf-bc0c-00aa00ac74f6");
pub const KSTIME_FORMAT_MEDIA_TIME = Guid.initString("7b785574-8c82-11cf-bc0c-00aa00ac74f6");
pub const KSINTERFACESETID_Standard = Guid.initString("1a8766a0-62ce-11cf-a5d6-28db04c10000");
pub const KSINTERFACESETID_FileIo = Guid.initString("8c6f932c-e771-11d0-b8ff-00a0c9223196");
pub const KSMEDIUMSETID_Standard = Guid.initString("4747b320-62ce-11cf-a5d6-28db04c10000");
pub const KSPROPSETID_Pin = Guid.initString("8c134960-51ad-11cf-878a-94f801c10000");
pub const KSEVENTSETID_PinCapsChange = Guid.initString("dd4f192e-3b78-49ad-a534-2c315b822000");
pub const KSEVENTSETID_VolumeLimit = Guid.initString("da168465-3a7c-4858-9d4a-3e8e24701aef");
pub const KSNAME_Filter = Guid.initString("9b365890-165f-11d0-a195-0020afd156e4");
pub const KSNAME_Pin = Guid.initString("146f1a80-4791-11d0-a5d6-28db04c10000");
pub const KSNAME_Clock = Guid.initString("53172480-4791-11d0-a5d6-28db04c10000");
pub const KSNAME_Allocator = Guid.initString("642f5d00-4791-11d0-a5d6-28db04c10000");
pub const KSNAME_TopologyNode = Guid.initString("0621061a-ee75-11d0-b915-00a0c9223196");
pub const KSDATAFORMAT_TYPE_STREAM = Guid.initString("e436eb83-524f-11ce-9f53-0020af0ba770");
pub const KSDATAFORMAT_SUBTYPE_NONE = Guid.initString("e436eb8e-524f-11ce-9f53-0020af0ba770");
pub const KSDATAFORMAT_SPECIFIER_FILENAME = Guid.initString("aa797b40-e974-11cf-a5d6-28db04c10000");
pub const KSDATAFORMAT_SPECIFIER_FILEHANDLE = Guid.initString("65e8773c-8f56-11d0-a3b9-00a0c9223196");
pub const KSDATAFORMAT_SPECIFIER_NONE = Guid.initString("0f6417d6-c318-11d0-a43f-00a0c9223196");
pub const KSPROPSETID_Quality = Guid.initString("d16ad380-ac1a-11cf-a5d6-28db04c10000");
pub const KSPROPSETID_Connection = Guid.initString("1d58c920-ac9b-11cf-a5d6-28db04c10000");
pub const KSPROPSETID_MemoryTransport = Guid.initString("0a3d1c5d-5243-4819-9ed0-aee8044cee2b");
pub const KSMEMORY_TYPE_SYSTEM = Guid.initString("091bb638-603f-11d1-b067-00a0c9062802");
pub const KSMEMORY_TYPE_USER = Guid.initString("8cb0fc28-7893-11d1-b069-00a0c9062802");
pub const KSMEMORY_TYPE_KERNEL_PAGED = Guid.initString("d833f8f8-7894-11d1-b069-00a0c9062802");
pub const KSMEMORY_TYPE_KERNEL_NONPAGED = Guid.initString("4a6d5fc4-7895-11d1-b069-00a0c9062802");
pub const KSMEMORY_TYPE_DEVICE_UNKNOWN = Guid.initString("091bb639-603f-11d1-b067-00a0c9062802");
pub const KSEVENTSETID_StreamAllocator = Guid.initString("75d95571-073c-11d0-a161-0020afd156e4");
pub const KSMETHODSETID_StreamAllocator = Guid.initString("cf6e4341-ec87-11cf-a130-0020afd156e4");
pub const KSPROPSETID_StreamAllocator = Guid.initString("cf6e4342-ec87-11cf-a130-0020afd156e4");
pub const KSPROPSETID_StreamInterface = Guid.initString("1fdd8ee1-9cd3-11d0-82aa-0000f822fe8a");
pub const KSPROPSETID_Stream = Guid.initString("65aaba60-98ae-11cf-a10d-0020afd156e4");
pub const KSPROPSETID_PinMDLCacheClearProp = Guid.initString("bd718a7b-97fc-40c7-88ce-d3ff06f55b16");
pub const KSPROPSETID_Clock = Guid.initString("df12a4c0-ac17-11cf-a5d6-28db04c10000");
pub const KSEVENTSETID_Clock = Guid.initString("364d8e20-62c7-11cf-a5d6-28db04c10000");
pub const KSEVENTSETID_Connection = Guid.initString("7f4bcbe0-9ea5-11cf-a5d6-28db04c10000");
pub const KSEVENTSETID_Device = Guid.initString("288296ec-9f94-41b4-a153-aa31aeecb33f");
pub const KSDEGRADESETID_Standard = Guid.initString("9f564180-704c-11d0-a5d6-28db04c10000");
pub const KSMEDIUMSETID_MidiBus = Guid.initString("05908040-3246-11d0-a5d6-28db04c10000");
pub const KSMEDIUMSETID_VPBus = Guid.initString("a18c15ec-ce43-11d0-abe7-00a0c9223196");
pub const KSINTERFACESETID_Media = Guid.initString("3a13eb40-30a7-11d0-a5d6-28db04c10000");
pub const KSCOMPONENTID_USBAUDIO = Guid.initString("8f1275f0-26e9-4264-ba4d-39fff01d94aa");
pub const KSNODETYPE_INPUT_UNDEFINED = Guid.initString("dff21be0-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_MICROPHONE = Guid.initString("dff21be1-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_DESKTOP_MICROPHONE = Guid.initString("dff21be2-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_PERSONAL_MICROPHONE = Guid.initString("dff21be3-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_OMNI_DIRECTIONAL_MICROPHONE = Guid.initString("dff21be4-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_MICROPHONE_ARRAY = Guid.initString("dff21be5-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_PROCESSING_MICROPHONE_ARRAY = Guid.initString("dff21be6-f70f-11d0-b917-00a0c9223196");
pub const KSCATEGORY_MICROPHONE_ARRAY_PROCESSOR = Guid.initString("830a44f2-a32d-476b-be97-42845673b35a");
pub const KSNODETYPE_OUTPUT_UNDEFINED = Guid.initString("dff21ce0-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_SPEAKER = Guid.initString("dff21ce1-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_HEADPHONES = Guid.initString("dff21ce2-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_HEAD_MOUNTED_DISPLAY_AUDIO = Guid.initString("dff21ce3-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_DESKTOP_SPEAKER = Guid.initString("dff21ce4-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_ROOM_SPEAKER = Guid.initString("dff21ce5-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_COMMUNICATION_SPEAKER = Guid.initString("dff21ce6-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_LOW_FREQUENCY_EFFECTS_SPEAKER = Guid.initString("dff21ce7-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_BIDIRECTIONAL_UNDEFINED = Guid.initString("dff21de0-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_HANDSET = Guid.initString("dff21de1-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_HEADSET = Guid.initString("dff21de2-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_SPEAKERPHONE_NO_ECHO_REDUCTION = Guid.initString("dff21de3-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_ECHO_SUPPRESSING_SPEAKERPHONE = Guid.initString("dff21de4-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_ECHO_CANCELING_SPEAKERPHONE = Guid.initString("dff21de5-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_TELEPHONY_UNDEFINED = Guid.initString("dff21ee0-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_PHONE_LINE = Guid.initString("dff21ee1-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_TELEPHONE = Guid.initString("dff21ee2-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_DOWN_LINE_PHONE = Guid.initString("dff21ee3-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_EXTERNAL_UNDEFINED = Guid.initString("dff21fe0-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_ANALOG_CONNECTOR = Guid.initString("dff21fe1-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_DIGITAL_AUDIO_INTERFACE = Guid.initString("dff21fe2-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_LINE_CONNECTOR = Guid.initString("dff21fe3-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_LEGACY_AUDIO_CONNECTOR = Guid.initString("dff21fe4-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_SPDIF_INTERFACE = Guid.initString("dff21fe5-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_1394_DA_STREAM = Guid.initString("dff21fe6-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_1394_DV_STREAM_SOUNDTRACK = Guid.initString("dff21fe7-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_EMBEDDED_UNDEFINED = Guid.initString("dff220e0-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_LEVEL_CALIBRATION_NOISE_SOURCE = Guid.initString("dff220e1-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_EQUALIZATION_NOISE = Guid.initString("dff220e2-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_CD_PLAYER = Guid.initString("dff220e3-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_DAT_IO_DIGITAL_AUDIO_TAPE = Guid.initString("dff220e4-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_DCC_IO_DIGITAL_COMPACT_CASSETTE = Guid.initString("dff220e5-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_MINIDISK = Guid.initString("dff220e6-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_ANALOG_TAPE = Guid.initString("dff220e7-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_PHONOGRAPH = Guid.initString("dff220e8-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_VCR_AUDIO = Guid.initString("dff220e9-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_VIDEO_DISC_AUDIO = Guid.initString("dff220ea-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_DVD_AUDIO = Guid.initString("dff220eb-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_TV_TUNER_AUDIO = Guid.initString("dff220ec-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_SATELLITE_RECEIVER_AUDIO = Guid.initString("dff220ed-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_CABLE_TUNER_AUDIO = Guid.initString("dff220ee-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_DSS_AUDIO = Guid.initString("dff220ef-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_RADIO_RECEIVER = Guid.initString("dff220f0-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_RADIO_TRANSMITTER = Guid.initString("dff220f1-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_MULTITRACK_RECORDER = Guid.initString("dff220f2-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_SYNTHESIZER = Guid.initString("dff220f3-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_HDMI_INTERFACE = Guid.initString("d1b9cc2a-f519-417f-91c9-55fa65481001");
pub const KSNODETYPE_DISPLAYPORT_INTERFACE = Guid.initString("e47e4031-3ea6-418d-8f9b-b73843ccba97");
pub const KSNODETYPE_AUDIO_LOOPBACK = Guid.initString("8f42c0b2-91ce-4bcf-9ccd-0e599037ab35");
pub const KSNODETYPE_AUDIO_KEYWORDDETECTOR = Guid.initString("3817e0b8-df58-4375-b669-c49634331f9d");
pub const KSNODETYPE_AUDIO_MODULE = Guid.initString("45aab42e-caeb-4052-8aa9-b38cb5109619");
pub const KSNODETYPE_MIDI_JACK = Guid.initString("265e0c3f-fa39-4df3-ab04-be01b91e299a");
pub const KSNODETYPE_MIDI_ELEMENT = Guid.initString("01c6fe66-6e48-4c65-ac9b-52db5d656c7e");
pub const KSNODETYPE_AUDIO_ENGINE = Guid.initString("35caf6e4-f3b3-4168-bb4b-55e77a461c7e");
pub const KSNODETYPE_SPEAKERS_STATIC_JACK = Guid.initString("28e04f87-4dbe-4f8d-8589-025d209dfb4a");
pub const PINNAME_SPDIF_OUT = Guid.initString("3a264481-e52c-4b82-8e7a-c8e2f91dc380");
pub const PINNAME_SPDIF_IN = Guid.initString("15dc9025-22ad-41b3-8875-f4ceb0299e20");
pub const PINNAME_HDMI_OUT = Guid.initString("387bfc03-e7ef-4901-86e0-35b7c32b00ef");
pub const PINNAME_DISPLAYPORT_OUT = Guid.initString("21fbb329-1a4a-48da-a076-2318a3c59b26");
pub const KSNODETYPE_DRM_DESCRAMBLE = Guid.initString("ffbb6e3f-ccfe-4d84-90d9-421418b03a8e");
pub const KSNODETYPE_TELEPHONY_BIDI = Guid.initString("686d7cc0-d903-4258-b443-3a3d3580741c");
pub const KSNODETYPE_FM_RX = Guid.initString("834a733c-f485-41c0-a62b-513025014e40");
pub const KSCATEGORY_AUDIO = Guid.initString("6994ad04-93ef-11d0-a3cc-00a0c9223196");
pub const KSCATEGORY_VIDEO = Guid.initString("6994ad05-93ef-11d0-a3cc-00a0c9223196");
pub const KSCATEGORY_REALTIME = Guid.initString("eb115ffc-10c8-4964-831d-6dcb02e6f23f");
pub const KSCATEGORY_TEXT = Guid.initString("6994ad06-93ef-11d0-a3cc-00a0c9223196");
pub const KSCATEGORY_NETWORK = Guid.initString("67c9cc3c-69c4-11d2-8759-00a0c9223196");
pub const KSCATEGORY_TOPOLOGY = Guid.initString("dda54a40-1e4c-11d1-a050-405705c10000");
pub const KSCATEGORY_VIRTUAL = Guid.initString("3503eac4-1f26-11d1-8ab0-00a0c9223196");
pub const KSCATEGORY_ACOUSTIC_ECHO_CANCEL = Guid.initString("bf963d80-c559-11d0-8a2b-00a0c9255ac1");
pub const KSCATEGORY_WDMAUD_USE_PIN_NAME = Guid.initString("47a4fa20-a251-11d1-a050-0000f8004788");
pub const KSCATEGORY_ESCALANTE_PLATFORM_DRIVER = Guid.initString("74f3aea8-9768-11d1-8e07-00a0c95ec22e");
pub const KSDATAFORMAT_TYPE_VIDEO = Guid.initString("73646976-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_TYPE_AUDIO = Guid.initString("73647561-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_TYPE_TEXT = Guid.initString("73747874-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_WAVEFORMATEX = Guid.initString("00000000-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_ANALOG = Guid.initString("6dba3190-67bd-11cf-a0f7-0020afd156e4");
pub const KSDATAFORMAT_SUBTYPE_PCM = Guid.initString("00000001-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SPECIFIER_VC_ID = Guid.initString("ad98d184-aac3-11d0-a41c-00a0c9223196");
pub const KSDATAFORMAT_SPECIFIER_WAVEFORMATEX = Guid.initString("05589f81-c356-11ce-bf01-00aa0055595a");
pub const KSDATAFORMAT_SPECIFIER_DSOUND = Guid.initString("518590a2-a184-11d0-8522-00c04fd9baf3");
pub const KSPROPSETID_DirectSound3DListener = Guid.initString("437b3414-d060-11d0-8583-00c04fd9baf3");
pub const KSPROPSETID_DirectSound3DBuffer = Guid.initString("437b3411-d060-11d0-8583-00c04fd9baf3");
pub const KSPROPSETID_Hrtf3d = Guid.initString("b66decb0-a083-11d0-851e-00c04fd9baf3");
pub const KSPROPSETID_Itd3d = Guid.initString("6429f090-9fd9-11d0-a75b-00a0c90365e3");
pub const KSDATAFORMAT_SUBTYPE_RIFF = Guid.initString("4995daee-9ee6-11d0-a40e-00a0c9223196");
pub const KSDATAFORMAT_SUBTYPE_RIFFWAVE = Guid.initString("e436eb8b-524f-11ce-9f53-0020af0ba770");
pub const KSPROPSETID_Bibliographic = Guid.initString("07ba150e-e2b1-11d0-ac17-00a0c9223196");
pub const KSPROPSETID_TopologyNode = Guid.initString("45ffaaa1-6e1b-11d0-bcf2-444553540000");
pub const KSPROPSETID_RtAudio = Guid.initString("a855a48c-2f78-4729-9051-1968746b9eef");
pub const KSPROPSETID_BtAudio = Guid.initString("7fa06c40-b8f6-4c7e-8556-e8c33a12e54d");
pub const KSPROPSETID_DrmAudioStream = Guid.initString("2f2c8ddd-4198-4fac-ba29-61bb05b7de06");
pub const KSPROPSETID_SoundDetector = Guid.initString("113c425e-fd17-4057-b422-ed4074f1afdf");
pub const KSPROPSETID_SoundDetector2 = Guid.initString("fe07e322-450c-4bd5-84ca-a948500ea6aa");
pub const KSPROPSETID_InterleavedAudio = Guid.initString("e9ebe550-d619-4c0a-976b-7062322b3006");
pub const KSEVENTSETID_SoundDetector = Guid.initString("69785c9b-fc2d-49d6-ac32-4799f87de9f6");
pub const KSNOTIFICATIONID_SoundDetector = Guid.initString("6389d844-bb32-4c4c-a802-f4b4b77afead");
pub const KSPROPSETID_Audio = Guid.initString("45ffaaa0-6e1b-11d0-bcf2-444553540000");
pub const KSPROPSETID_TelephonyControl = Guid.initString("b6df7eb1-d099-489f-a6a0-c0106f0887a7");
pub const KSPROPSETID_TelephonyTopology = Guid.initString("abf25c7e-0e64-4e32-b190-d0f6d7c53e97");
pub const KSPROPSETID_FMRXTopology = Guid.initString("0c46ce8f-dc2d-4204-9dc9-f58963366563");
pub const KSPROPSETID_FMRXControl = Guid.initString("947bba3a-e8ee-4786-90c4-8428185f05be");
pub const KSEVENTSETID_Telephony = Guid.initString("b77f12b4-ceb4-4484-8d5e-52c1e7d8762d");
pub const KSNODETYPE_DAC = Guid.initString("507ae360-c554-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_ADC = Guid.initString("4d837fe0-c555-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_SRC = Guid.initString("9db7b9e0-c555-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_SUPERMIX = Guid.initString("e573adc0-c555-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_MUX = Guid.initString("2ceaf780-c556-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_DEMUX = Guid.initString("c0eb67d4-e807-11d0-958a-00c04fb925d3");
pub const KSNODETYPE_SUM = Guid.initString("da441a60-c556-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_MUTE = Guid.initString("02b223c0-c557-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_VOLUME = Guid.initString("3a5acc00-c557-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_TONE = Guid.initString("7607e580-c557-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_EQUALIZER = Guid.initString("9d41b4a0-c557-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_AGC = Guid.initString("e88c9ba0-c557-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_NOISE_SUPPRESS = Guid.initString("e07f903f-62fd-4e60-8cdd-dea7236665b5");
pub const KSNODETYPE_DELAY = Guid.initString("144981e0-c558-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_LOUDNESS = Guid.initString("41887440-c558-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_PROLOGIC_DECODER = Guid.initString("831c2c80-c558-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_STEREO_WIDE = Guid.initString("a9e69800-c558-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_REVERB = Guid.initString("ef0328e0-c558-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_CHORUS = Guid.initString("20173f20-c559-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_3D_EFFECTS = Guid.initString("55515860-c559-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_PARAMETRIC_EQUALIZER = Guid.initString("19bb3a6a-ce2b-4442-87ec-6727c3cab477");
pub const KSNODETYPE_UPDOWN_MIX = Guid.initString("b7edc5cf-7b63-4ee2-a100-29ee2cb6b2de");
pub const KSNODETYPE_DYN_RANGE_COMPRESSOR = Guid.initString("08c8a6a8-601f-4af8-8793-d905ff4ca97d");
pub const KSALGORITHMINSTANCE_SYSTEM_ACOUSTIC_ECHO_CANCEL = Guid.initString("1c22c56d-9879-4f5b-a389-27996ddc2810");
pub const KSALGORITHMINSTANCE_SYSTEM_NOISE_SUPPRESS = Guid.initString("5ab0882e-7274-4516-877d-4eee99ba4fd0");
pub const KSALGORITHMINSTANCE_SYSTEM_AGC = Guid.initString("950e55b9-877c-4c67-be08-e47b5611130a");
pub const KSALGORITHMINSTANCE_SYSTEM_MICROPHONE_ARRAY_PROCESSOR = Guid.initString("b6f5a0a0-9e61-4f8c-91e3-76cf0f3c471f");
pub const KSNODETYPE_DEV_SPECIFIC = Guid.initString("941c7ac0-c559-11d0-8a2b-00a0c9255ac1");
pub const KSNODETYPE_PROLOGIC_ENCODER = Guid.initString("8074c5b2-3c66-11d2-b45a-3078302c2030");
pub const KSNODETYPE_PEAKMETER = Guid.initString("a085651e-5f0d-4b36-a869-d195d6ab4b9e");
pub const KSAUDFNAME_BASS = Guid.initString("185fede0-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_TREBLE = Guid.initString("185fede1-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MIDRANGE = Guid.initString("a2cbe478-ae84-49a1-8b72-4ad09b78ed34");
pub const KSAUDFNAME_3D_STEREO = Guid.initString("185fede2-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MASTER_VOLUME = Guid.initString("185fede3-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MASTER_MUTE = Guid.initString("185fede4-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_WAVE_VOLUME = Guid.initString("185fede5-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_WAVE_MUTE = Guid.initString("185fede6-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MIDI_VOLUME = Guid.initString("185fede7-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MIDI_MUTE = Guid.initString("185fede8-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_CD_VOLUME = Guid.initString("185fede9-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_CD_MUTE = Guid.initString("185fedea-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_LINE_VOLUME = Guid.initString("185fedeb-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_LINE_MUTE = Guid.initString("185fedec-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MIC_VOLUME = Guid.initString("185feded-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MIC_MUTE = Guid.initString("185fedee-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_RECORDING_SOURCE = Guid.initString("185fedef-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_PC_SPEAKER_VOLUME = Guid.initString("185fedf0-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_PC_SPEAKER_MUTE = Guid.initString("185fedf1-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MIDI_IN_VOLUME = Guid.initString("185fedf2-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_CD_IN_VOLUME = Guid.initString("185fedf3-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_LINE_IN_VOLUME = Guid.initString("185fedf4-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MIC_IN_VOLUME = Guid.initString("185fedf5-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_WAVE_IN_VOLUME = Guid.initString("185fedf6-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_VOLUME_CONTROL = Guid.initString("185fedf7-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MIDI = Guid.initString("185fedf8-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_LINE_IN = Guid.initString("185fedf9-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_RECORDING_CONTROL = Guid.initString("185fedfa-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_CD_AUDIO = Guid.initString("185fedfb-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_AUX_VOLUME = Guid.initString("185fedfc-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_AUX_MUTE = Guid.initString("185fedfd-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_AUX = Guid.initString("185fedfe-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_PC_SPEAKER = Guid.initString("185fedff-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_WAVE_OUT_MIX = Guid.initString("185fee00-9905-11d1-95a9-00c04fb925d3");
pub const KSAUDFNAME_MONO_OUT = Guid.initString("f9b41dc3-96e2-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_STEREO_MIX = Guid.initString("00dff077-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_MONO_MIX = Guid.initString("00dff078-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_MONO_OUT_VOLUME = Guid.initString("1ad247eb-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_MONO_OUT_MUTE = Guid.initString("1ad247ec-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_STEREO_MIX_VOLUME = Guid.initString("1ad247ed-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_STEREO_MIX_MUTE = Guid.initString("22b0eafd-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_MONO_MIX_VOLUME = Guid.initString("22b0eafe-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_MONO_MIX_MUTE = Guid.initString("2bc31d69-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_MICROPHONE_BOOST = Guid.initString("2bc31d6a-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_ALTERNATE_MICROPHONE = Guid.initString("2bc31d6b-96e3-11d2-ac4c-00c04f8efb68");
pub const KSAUDFNAME_3D_DEPTH = Guid.initString("63ff5747-991f-11d2-ac4d-00c04f8efb68");
pub const KSAUDFNAME_3D_CENTER = Guid.initString("9f0670b4-991f-11d2-ac4d-00c04f8efb68");
pub const KSAUDFNAME_VIDEO_VOLUME = Guid.initString("9b46e708-992a-11d2-ac4d-00c04f8efb68");
pub const KSAUDFNAME_VIDEO_MUTE = Guid.initString("9b46e709-992a-11d2-ac4d-00c04f8efb68");
pub const KSAUDFNAME_VIDEO = Guid.initString("915daec4-a434-11d2-ac52-00c04f8efb68");
pub const KSAUDFNAME_PEAKMETER = Guid.initString("57e24340-fc5b-4612-a562-72b11a29dfae");
pub const KSMETHODSETID_Wavetable = Guid.initString("dcef31eb-d907-11d0-9583-00c04fb925d3");
pub const KSPROPSETID_Wave = Guid.initString("924e54b0-630f-11cf-ada7-08003e30494a");
pub const KSMUSIC_TECHNOLOGY_PORT = Guid.initString("86c92e60-62e8-11cf-a5d6-28db04c10000");
pub const KSMUSIC_TECHNOLOGY_SQSYNTH = Guid.initString("0ecf4380-62e9-11cf-a5d6-28db04c10000");
pub const KSMUSIC_TECHNOLOGY_FMSYNTH = Guid.initString("252c5c80-62e9-11cf-a5d6-28db04c10000");
pub const KSMUSIC_TECHNOLOGY_WAVETABLE = Guid.initString("394ec7c0-62e9-11cf-a5d6-28db04c10000");
pub const KSMUSIC_TECHNOLOGY_SWSYNTH = Guid.initString("37407736-3620-11d1-85d3-0000f8754380");
pub const KSPROPSETID_Cyclic = Guid.initString("3ffeaea0-2bee-11cf-a5d6-28db04c10000");
pub const KSEVENTSETID_AudioControlChange = Guid.initString("e85e9698-fa2f-11d1-95bd-00c04fb925d3");
pub const KSEVENTSETID_LoopedStreaming = Guid.initString("4682b940-c6ef-11d0-96d8-00aa0051e51d");
pub const KSDATAFORMAT_TYPE_MUSIC = Guid.initString("e725d360-62cc-11cf-a5d6-28db04c10000");
pub const KSDATAFORMAT_TYPE_MIDI = Guid.initString("7364696d-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_MIDI = Guid.initString("1d262760-e957-11cf-a5d6-28db04c10000");
pub const KSDATAFORMAT_SUBTYPE_MIDI_BUS = Guid.initString("2ca15fa0-6cfe-11cf-a5d6-28db04c10000");
pub const KSDATAFORMAT_SUBTYPE_RIFFMIDI = Guid.initString("4995daf0-9ee6-11d0-a40e-00a0c9223196");
pub const KSDATAFORMAT_TYPE_STANDARD_ELEMENTARY_STREAM = Guid.initString("36523b11-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_TYPE_STANDARD_PES_PACKET = Guid.initString("36523b12-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_TYPE_STANDARD_PACK_HEADER = Guid.initString("36523b13-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SUBTYPE_STANDARD_MPEG1_VIDEO = Guid.initString("36523b21-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SUBTYPE_STANDARD_MPEG1_AUDIO = Guid.initString("36523b22-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SUBTYPE_STANDARD_MPEG2_VIDEO = Guid.initString("36523b23-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SUBTYPE_STANDARD_MPEG2_AUDIO = Guid.initString("36523b24-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SUBTYPE_STANDARD_AC3_AUDIO = Guid.initString("36523b25-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SPECIFIER_DIALECT_MPEG1_VIDEO = Guid.initString("36523b31-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SPECIFIER_DIALECT_MPEG1_AUDIO = Guid.initString("36523b32-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SPECIFIER_DIALECT_MPEG2_VIDEO = Guid.initString("36523b33-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SPECIFIER_DIALECT_MPEG2_AUDIO = Guid.initString("36523b34-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SPECIFIER_DIALECT_AC3_AUDIO = Guid.initString("36523b35-8ee5-11d1-8ca3-0060b057664a");
pub const KSDATAFORMAT_SUBTYPE_DSS_VIDEO = Guid.initString("a0af4f81-e163-11d0-bad9-00609744111a");
pub const KSDATAFORMAT_SUBTYPE_DSS_AUDIO = Guid.initString("a0af4f82-e163-11d0-bad9-00609744111a");
pub const KSDATAFORMAT_SUBTYPE_MPEG1Packet = Guid.initString("e436eb80-524f-11ce-9f53-0020af0ba770");
pub const KSDATAFORMAT_SUBTYPE_MPEG1Payload = Guid.initString("e436eb81-524f-11ce-9f53-0020af0ba770");
pub const KSDATAFORMAT_SUBTYPE_MPEG1Video = Guid.initString("e436eb86-524f-11ce-9f53-0020af0ba770");
pub const KSDATAFORMAT_SPECIFIER_MPEG1_VIDEO = Guid.initString("05589f82-c356-11ce-bf01-00aa0055595a");
pub const KSDATAFORMAT_TYPE_MPEG2_PES = Guid.initString("e06d8020-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_TYPE_MPEG2_PROGRAM = Guid.initString("e06d8022-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_TYPE_MPEG2_TRANSPORT = Guid.initString("e06d8023-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_SUBTYPE_MPEG2_VIDEO = Guid.initString("e06d8026-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_SPECIFIER_MPEG2_VIDEO = Guid.initString("e06d80e3-db46-11cf-b4d1-00805f6cbbea");
pub const KSPROPSETID_Mpeg2Vid = Guid.initString("c8e11b60-0cc9-11d0-bd69-003505c103a9");
pub const KSDATAFORMAT_SUBTYPE_MPEG2_AUDIO = Guid.initString("e06d802b-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_SPECIFIER_MPEG2_AUDIO = Guid.initString("e06d80e5-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_SUBTYPE_LPCM_AUDIO = Guid.initString("e06d8032-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_SPECIFIER_LPCM_AUDIO = Guid.initString("e06d80e6-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_SUBTYPE_AC3_AUDIO = Guid.initString("e06d802c-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_SPECIFIER_AC3_AUDIO = Guid.initString("e06d80e4-db46-11cf-b4d1-00805f6cbbea");
pub const KSPROPSETID_AC3 = Guid.initString("bfabe720-6e1f-11d0-bcf2-444553540000");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_DIGITAL = Guid.initString("00000092-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_WMA_PRO = Guid.initString("00000164-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DTS = Guid.initString("00000008-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_MPEG1 = Guid.initString("00000003-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_MPEG2 = Guid.initString("00000004-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_MPEG3 = Guid.initString("00000005-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_AAC = Guid.initString("00000006-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_ATRAC = Guid.initString("00000008-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_ONE_BIT_AUDIO = Guid.initString("00000009-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_DIGITAL_PLUS = Guid.initString("0000000a-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_DIGITAL_PLUS_ATMOS = Guid.initString("0000010a-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DTS_HD = Guid.initString("0000000b-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DTSX_E1 = Guid.initString("0000010b-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DTSX_E2 = Guid.initString("0000030b-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MLP = Guid.initString("0000000c-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT20 = Guid.initString("0000010c-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_MAT21 = Guid.initString("0000030c-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_IEC61937_DST = Guid.initString("0000000d-0cea-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_MPEGLAYER3 = Guid.initString("00000055-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_MPEG_HEAAC = Guid.initString("00001610-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_WMAUDIO2 = Guid.initString("00000161-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_WMAUDIO3 = Guid.initString("00000162-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_WMAUDIO_LOSSLESS = Guid.initString("00000163-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_DTS_AUDIO = Guid.initString("e06d8033-db46-11cf-b4d1-00805f6cbbea");
pub const KSDATAFORMAT_SUBTYPE_SDDS_AUDIO = Guid.initString("e06d8034-db46-11cf-b4d1-00805f6cbbea");
pub const KSPROPSETID_AudioDecoderOut = Guid.initString("6ca6e020-43bd-11d0-bd6a-003505c103a9");
pub const KSDATAFORMAT_SUBTYPE_SUBPICTURE = Guid.initString("e06d802d-db46-11cf-b4d1-00805f6cbbea");
pub const KSPROPSETID_DvdSubPic = Guid.initString("ac390460-43af-11d0-bd6a-003505c103a9");
pub const KSPROPSETID_CopyProt = Guid.initString("0e8a0a40-6aef-11d0-9ed0-00a024ca19b3");
pub const KSCATEGORY_TVTUNER = Guid.initString("a799a800-a46d-11d0-a18c-00a02401dcd4");
pub const KSCATEGORY_CROSSBAR = Guid.initString("a799a801-a46d-11d0-a18c-00a02401dcd4");
pub const KSCATEGORY_TVAUDIO = Guid.initString("a799a802-a46d-11d0-a18c-00a02401dcd4");
pub const KSCATEGORY_VPMUX = Guid.initString("a799a803-a46d-11d0-a18c-00a02401dcd4");
pub const KSCATEGORY_VBICODEC = Guid.initString("07dad660-22f1-11d1-a9f4-00c04fbbde8f");
pub const KSDATAFORMAT_SUBTYPE_VPVideo = Guid.initString("5a9b6a40-1a22-11d1-bad9-00609744111a");
pub const KSDATAFORMAT_SUBTYPE_VPVBI = Guid.initString("5a9b6a41-1a22-11d1-bad9-00609744111a");
pub const KSDATAFORMAT_SPECIFIER_VIDEOINFO = Guid.initString("05589f80-c356-11ce-bf01-00aa0055595a");
pub const KSDATAFORMAT_SPECIFIER_VIDEOINFO2 = Guid.initString("f72a76a0-eb0a-11d0-ace4-0000c0cc16ba");
pub const KSDATAFORMAT_SPECIFIER_H264_VIDEO = Guid.initString("2017be05-6629-4248-aaed-7e1a47bc9b9c");
pub const KSDATAFORMAT_SPECIFIER_JPEG_IMAGE = Guid.initString("692fa379-d3e8-4651-b5b4-0b94b013eeaf");
pub const KSDATAFORMAT_SPECIFIER_IMAGE = Guid.initString("692fa379-d3e8-4651-b5b4-0b94b013eeaf");
pub const KSDATAFORMAT_TYPE_IMAGE = Guid.initString("72178c23-e45b-11d5-bc2a-00b0d0f3f4ab");
pub const KSDATAFORMAT_SUBTYPE_JPEG = Guid.initString("19e4a5aa-5662-4fc5-a0c0-1758028e1057");
pub const KSDATAFORMAT_SUBTYPE_IMAGE_RGB32 = Guid.initString("00000016-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_L8 = Guid.initString("00000032-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_L8_IR = Guid.initString("00000032-0002-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_L8_CUSTOM = Guid.initString("00000032-8000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_L16 = Guid.initString("00000051-0000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_L16_IR = Guid.initString("00000051-0002-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_D16 = Guid.initString("00000050-0004-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_L16_CUSTOM = Guid.initString("00000051-8000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_MJPG_IR = Guid.initString("47504a4d-0002-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_MJPG_DEPTH = Guid.initString("47504a4d-0004-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_SUBTYPE_MJPG_CUSTOM = Guid.initString("47504a4d-8000-0010-8000-00aa00389b71");
pub const KSDATAFORMAT_TYPE_ANALOGVIDEO = Guid.initString("0482dde1-7817-11cf-8a03-00aa006ecb65");
pub const KSDATAFORMAT_SPECIFIER_ANALOGVIDEO = Guid.initString("0482dde0-7817-11cf-8a03-00aa006ecb65");
pub const KSDATAFORMAT_TYPE_ANALOGAUDIO = Guid.initString("0482dee1-7817-11cf-8a03-00aa006ecb65");
pub const KSDATAFORMAT_SPECIFIER_VBI = Guid.initString("f72a76e0-eb0a-11d0-ace4-0000c0cc16ba");
pub const KSDATAFORMAT_TYPE_VBI = Guid.initString("f72a76e1-eb0a-11d0-ace4-0000c0cc16ba");
pub const KSDATAFORMAT_SUBTYPE_RAW8 = Guid.initString("ca20d9a0-3e3e-11d1-9bf9-00c04fbbdebf");
pub const KSDATAFORMAT_SUBTYPE_CC = Guid.initString("33214cc1-011f-11d2-b4b1-00a0d102cfbe");
pub const KSDATAFORMAT_SUBTYPE_NABTS = Guid.initString("f72a76e2-eb0a-11d0-ace4-0000c0cc16ba");
pub const KSDATAFORMAT_SUBTYPE_TELETEXT = Guid.initString("f72a76e3-eb0a-11d0-ace4-0000c0cc16ba");
pub const KSPROPSETID_VBICAP_PROPERTIES = Guid.initString("f162c607-7b35-496f-ad7f-2dca3b46b718");
pub const KSDATAFORMAT_TYPE_NABTS = Guid.initString("e757bca0-39ac-11d1-a9f5-00c04fbbde8f");
pub const KSDATAFORMAT_SUBTYPE_NABTS_FEC = Guid.initString("e757bca1-39ac-11d1-a9f5-00c04fbbde8f");
pub const KSPROPSETID_VBICodecFiltering = Guid.initString("cafeb0ca-8715-11d0-bd6a-0035c0edbabe");
pub const PINNAME_VIDEO_CAPTURE = Guid.initString("fb6c4281-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_CC_CAPTURE = Guid.initString("1aad8061-012d-11d2-b4b1-00a0d102cfbe");
pub const PINNAME_VIDEO_NABTS_CAPTURE = Guid.initString("29703660-498a-11d2-b4b1-00a0d102cfbe");
pub const PINNAME_VIDEO_PREVIEW = Guid.initString("fb6c4282-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_ANALOGVIDEOIN = Guid.initString("fb6c4283-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_VBI = Guid.initString("fb6c4284-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_VIDEOPORT = Guid.initString("fb6c4285-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_NABTS = Guid.initString("fb6c4286-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_EDS = Guid.initString("fb6c4287-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_TELETEXT = Guid.initString("fb6c4288-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_CC = Guid.initString("fb6c4289-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_STILL = Guid.initString("fb6c428a-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_IMAGE = Guid.initString("38a0cd98-d49b-4ce8-b48a-344667a17830");
pub const PINNAME_VIDEO_TIMECODE = Guid.initString("fb6c428b-0353-11d1-905f-0000c0cc16ba");
pub const PINNAME_VIDEO_VIDEOPORT_VBI = Guid.initString("fb6c428c-0353-11d1-905f-0000c0cc16ba");
pub const KSPROPSETID_VramCapture = Guid.initString("e73face3-2880-4902-b799-88d0cd634e0f");
pub const KS_SECURE_CAMERA_SCENARIO_ID = Guid.initString("ae53fc6e-8d89-4488-9d2e-4d008731c5fd");
pub const KSPROPSETID_MPEG4_MediaType_Attributes = Guid.initString("ff6c4bfa-07a9-4c7b-a237-672f9d68065f");
pub const KSEVENTSETID_DynamicFormatChange = Guid.initString("162ac456-83d7-4239-96df-c75ffa138bc6");
pub const PROPSETID_ALLOCATOR_CONTROL = Guid.initString("53171960-148e-11d2-9979-0000c0cc16ba");
pub const PROPSETID_VIDCAP_VIDEOPROCAMP = Guid.initString("c6e13360-30ac-11d0-a18c-00a0c9118956");
pub const PROPSETID_VIDCAP_SELECTOR = Guid.initString("1abdaeca-68b6-4f83-9371-b413907c7b9f");
pub const PROPSETID_TUNER = Guid.initString("6a2e0605-28e4-11d0-a18c-00a0c9118956");
pub const EVENTSETID_TUNER = Guid.initString("6a2e0606-28e4-11d0-a18c-00a0c9118956");
pub const KSNODETYPE_VIDEO_STREAMING = Guid.initString("dff229e1-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_VIDEO_INPUT_TERMINAL = Guid.initString("dff229e2-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_VIDEO_OUTPUT_TERMINAL = Guid.initString("dff229e3-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_VIDEO_SELECTOR = Guid.initString("dff229e4-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_VIDEO_PROCESSING = Guid.initString("dff229e5-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_VIDEO_CAMERA_TERMINAL = Guid.initString("dff229e6-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_VIDEO_INPUT_MTT = Guid.initString("dff229e7-f70f-11d0-b917-00a0c9223196");
pub const KSNODETYPE_VIDEO_OUTPUT_MTT = Guid.initString("dff229e8-f70f-11d0-b917-00a0c9223196");
pub const PROPSETID_VIDCAP_VIDEOENCODER = Guid.initString("6a2e0610-28e4-11d0-a18c-00a0c9118956");
pub const PROPSETID_VIDCAP_VIDEODECODER = Guid.initString("c6e13350-30ac-11d0-a18c-00a0c9118956");
pub const EVENTSETID_VIDEODECODER = Guid.initString("6a2e0621-28e4-11d0-a18c-00a0c9118956");
pub const KSEVENTSETID_CameraAsyncControl = Guid.initString("22a11754-9701-4088-b33f-6b9cbc52df5e");
pub const PROPSETID_VIDCAP_CAMERACONTROL = Guid.initString("c6e13370-30ac-11d0-a18c-00a0c9118956");
pub const PROPSETID_VIDCAP_CAMERACONTROL_FLASH = Guid.initString("785e8f49-63a2-4144-ab70-ffb278fa26ce");
pub const PROPSETID_VIDCAP_CAMERACONTROL_VIDEO_STABILIZATION = Guid.initString("43964bd3-7716-404e-8be1-d299b20e50fd");
pub const PROPSETID_VIDCAP_CAMERACONTROL_REGION_OF_INTEREST = Guid.initString("9d12d198-f86c-4fed-b023-5d87653da793");
pub const EVENTSETID_VIDCAP_CAMERACONTROL_REGION_OF_INTEREST = Guid.initString("2fdffc5d-c732-4ba6-b5df-6b4d7fc88b8b");
pub const PROPSETID_VIDCAP_CAMERACONTROL_IMAGE_PIN_CAPABILITY = Guid.initString("9d3d7bbf-5c6d-4138-bb00-584edd20f7c5");
pub const KSPROPERTYSETID_ExtendedCameraControl = Guid.initString("1cb79112-c0d2-4213-9ca6-cd4fdb927972");
pub const KSEVENTSETID_ExtendedCameraControl = Guid.initString("571c92c9-13a2-47e3-a649-d2a778166384");
pub const KSEVENTSETID_CameraEvent = Guid.initString("7899b2e0-6b43-4964-9d2a-a21f4061f576");
pub const KSPROPERTYSETID_PerFrameSettingControl = Guid.initString("f1f3e261-dee6-4537-bff5-ee206db54aac");
pub const KSCAMERAPROFILE_Legacy = Guid.initString("b4894d81-62b7-4eec-8740-80658c4a9d3e");
pub const KSCAMERAPROFILE_VideoRecording = Guid.initString("a0e517e8-8f8c-4f6f-9a57-46fc2f647ec0");
pub const KSCAMERAPROFILE_HighQualityPhoto = Guid.initString("32440725-961b-4ca3-b5b2-854e719d9e1b");
pub const KSCAMERAPROFILE_BalancedVideoAndPhoto = Guid.initString("6b52b017-42c7-4a21-bfe3-23f009149887");
pub const KSCAMERAPROFILE_VideoConferencing = Guid.initString("c5444a88-e1bf-4597-b2dd-9e1ead864bb8");
pub const KSCAMERAPROFILE_PhotoSequence = Guid.initString("02399d9d-4ee8-49ba-bc07-5ff156531413");
pub const KSCAMERAPROFILE_FaceAuth_Mode = Guid.initString("81361b22-700b-4546-a2d4-c52e907bfc27");
pub const KSCAMERAPROFILE_HighFrameRate = Guid.initString("566e6113-8c35-48e7-b89f-d23fdc1219dc");
pub const KSCAMERAPROFILE_HDRWithWCGVideo = Guid.initString("4b27c336-4924-4989-b994-fdaf1dc7cd85");
pub const KSCAMERAPROFILE_HDRWithWCGPhoto = Guid.initString("9bf6f1ff-b555-4625-b326-a46def318fb7");
pub const KSCAMERAPROFILE_VariablePhotoSequence = Guid.initString("9ff2cb56-e75a-49b1-a928-9985d5946f87");
pub const KSCAMERAPROFILE_VideoHDR8 = Guid.initString("d4f3f4ec-bdff-4314-b1d4-008e281f74e7");
pub const KSCAMERAPROFILE_CompressedCamera = Guid.initString("0e34cdc1-27ad-437f-abde-02b629f37b44");
pub const KSPROPERTYSETID_NetworkCameraControl = Guid.initString("0e780f09-5745-4e3a-bc9f-f226ea43a6ec");
pub const PROPSETID_EXT_DEVICE = Guid.initString("b5730a90-1a2c-11cf-8c23-00aa006b6814");
pub const PROPSETID_EXT_TRANSPORT = Guid.initString("a03cd5f0-3045-11cf-8c44-00aa006b6814");
pub const PROPSETID_TIMECODE_READER = Guid.initString("9b496ce1-811b-11cf-8c77-00aa006b6814");
pub const KSEVENTSETID_EXTDEV_Command = Guid.initString("109c7988-b3cb-11d2-b48e-006097b3391b");
pub const PROPSETID_VIDCAP_CROSSBAR = Guid.initString("6a2e0640-28e4-11d0-a18c-00a0c9118956");
pub const EVENTSETID_CROSSBAR = Guid.initString("6a2e0641-28e4-11d0-a18c-00a0c9118956");
pub const PROPSETID_VIDCAP_TVAUDIO = Guid.initString("6a2e0650-28e4-11d0-a18c-00a0c9118956");
pub const KSEVENTSETID_VIDCAP_TVAUDIO = Guid.initString("6a2e0651-28e4-11d0-a18c-00a0c9118956");
pub const PROPSETID_VIDCAP_VIDEOCOMPRESSION = Guid.initString("c6e13343-30ac-11d0-a18c-00a0c9118956");
pub const KSDATAFORMAT_SUBTYPE_OVERLAY = Guid.initString("e436eb7f-524f-11ce-9f53-0020af0ba770");
pub const KSPROPSETID_OverlayUpdate = Guid.initString("490ea5cf-7681-11d1-a21c-00a0c9223196");
pub const PROPSETID_VIDCAP_VIDEOCONTROL = Guid.initString("6a2e0670-28e4-11d0-a18c-00a0c9118956");
pub const PROPSETID_VIDCAP_DROPPEDFRAMES = Guid.initString("c6e13344-30ac-11d0-a18c-00a0c9118956");
pub const KSPROPSETID_VPConfig = Guid.initString("bc29a660-30e3-11d0-9e69-00c04fd7c15b");
pub const KSPROPSETID_VPVBIConfig = Guid.initString("ec529b00-1a1f-11d1-bad9-00609744111a");
pub const CLSID_KsIBasicAudioInterfaceHandler = Guid.initString("b9f8ac3e-0f71-11d2-b72c-00c04fb6bd3d");
pub const KSEVENTSETID_VPNotify = Guid.initString("20c5598e-d3c8-11d0-8dfc-00c04fd7c08b");
pub const KSEVENTSETID_VIDCAPTOSTI = Guid.initString("db47de20-f628-11d1-ba41-00a0c90d2b05");
pub const KSEVENTSETID_VPVBINotify = Guid.initString("ec529b01-1a1f-11d1-bad9-00609744111a");
pub const KSDATAFORMAT_TYPE_AUXLine21Data = Guid.initString("670aea80-3a82-11d0-b79b-00aa003767a7");
pub const KSDATAFORMAT_SUBTYPE_Line21_BytePair = Guid.initString("6e8d4a22-310c-11d0-b79a-00aa003767a7");
pub const KSDATAFORMAT_SUBTYPE_Line21_GOPPacket = Guid.initString("6e8d4a23-310c-11d0-b79a-00aa003767a7");
pub const KSDATAFORMAT_TYPE_DVD_ENCRYPTED_PACK = Guid.initString("ed0b916a-044d-11d1-aa78-00c04fc31d60");
pub const KSPROPSETID_TSRateChange = Guid.initString("a503c5c0-1d1d-11d1-ad80-444553540000");
pub const KSCATEGORY_ENCODER = Guid.initString("19689bf6-c384-48fd-ad51-90e58c79f70b");
pub const KSCATEGORY_MULTIPLEXER = Guid.initString("7a5de1d3-01a1-452c-b481-4fa2b96271e8");
pub const KSPROPSETID_Jack = Guid.initString("4509f757-2d46-4637-8e62-ce7db944f57b");
pub const KSPROPSETID_AudioPosture = Guid.initString("a3fb7b0d-474e-4f51-a379-51282dd4fa8f");
pub const KSPROPSETID_AudioBufferDuration = Guid.initString("4e73c07f-23cc-4955-a7ea-3da502496290");
pub const KSPROPSETID_AudioEngine = Guid.initString("3a2f82dc-886f-4baa-9eb4-082b9025c536");
pub const KSPROPSETID_AudioSignalProcessing = Guid.initString("4f67b528-30c9-40de-b2fb-859ddd1f3470");
pub const KSATTRIBUTEID_AUDIOSIGNALPROCESSING_MODE = Guid.initString("e1f89eb5-5f46-419b-967b-ff6770b98401");
pub const AUDIO_SIGNALPROCESSINGMODE_DEFAULT = Guid.initString("c18e2f7e-933d-4965-b7d1-1eef228d2af3");
pub const AUDIO_SIGNALPROCESSINGMODE_RAW = Guid.initString("9e90ea20-b493-4fd1-a1a8-7e1361a956cf");
pub const KSPROPSETID_AudioResourceManagement = Guid.initString("d0b305e1-b2cc-484c-8f23-e5d28ad9cf88");
pub const BLUETOOTHLE_MIDI_SERVICE_UUID = Guid.initString("03b80e5a-ede8-4b33-a751-6ce34ec4c700");
pub const BLUETOOTH_MIDI_DATAIO_CHARACTERISTIC = Guid.initString("7772e5db-3868-4112-a1a9-f2669d106bf3");
pub const APO_CLASS_UUID = Guid.initString("5989fce8-9cd0-467d-8a6a-5419e31529d4");
pub const AUDIOENDPOINT_CLASS_UUID = Guid.initString("c166523c-fe0c-4a94-a586-f1a80cfbbf3e");
pub const AUDIO_SIGNALPROCESSINGMODE_COMMUNICATIONS = Guid.initString("98951333-b9cd-48b1-a0a3-ff40682d73f7");
pub const AUDIO_SIGNALPROCESSINGMODE_SPEECH = Guid.initString("fc1cfc9b-b9d6-4cfa-b5e0-4bb2166878b2");
pub const AUDIO_SIGNALPROCESSINGMODE_NOTIFICATION = Guid.initString("9cf2a70b-f377-403b-bd6b-360863e0355c");
pub const AUDIO_SIGNALPROCESSINGMODE_MEDIA = Guid.initString("4780004e-7133-41d8-8c74-660dadd2c0ee");
pub const AUDIO_SIGNALPROCESSINGMODE_MOVIE = Guid.initString("b26feb0d-ec94-477c-9494-d1ab8e753f6e");
pub const AUDIO_SIGNALPROCESSINGMODE_FAR_FIELD_SPEECH = Guid.initString("28941cba-3be6-4a78-9a76-30fd91559b64");
pub const AUDIO_EFFECT_TYPE_ACOUSTIC_ECHO_CANCELLATION = Guid.initString("6f64adbe-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_NOISE_SUPPRESSION = Guid.initString("6f64adbf-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_AUTOMATIC_GAIN_CONTROL = Guid.initString("6f64adc0-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_BEAMFORMING = Guid.initString("6f64adc1-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_CONSTANT_TONE_REMOVAL = Guid.initString("6f64adc2-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_EQUALIZER = Guid.initString("6f64adc3-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_LOUDNESS_EQUALIZER = Guid.initString("6f64adc4-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_BASS_BOOST = Guid.initString("6f64adc5-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_VIRTUAL_SURROUND = Guid.initString("6f64adc6-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_VIRTUAL_HEADPHONES = Guid.initString("6f64adc7-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_SPEAKER_FILL = Guid.initString("6f64adc8-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_ROOM_CORRECTION = Guid.initString("6f64adc9-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_BASS_MANAGEMENT = Guid.initString("6f64adca-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_ENVIRONMENTAL_EFFECTS = Guid.initString("6f64adcb-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_SPEAKER_PROTECTION = Guid.initString("6f64adcc-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_SPEAKER_COMPENSATION = Guid.initString("6f64adcd-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_DYNAMIC_RANGE_COMPRESSION = Guid.initString("6f64adce-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_FAR_FIELD_BEAMFORMING = Guid.initString("6f64adcf-8211-11e2-8c70-2c27d7f001fa");
pub const AUDIO_EFFECT_TYPE_DEEP_NOISE_SUPPRESSION = Guid.initString("6f64add0-8211-11e2-8c70-2c27d7f001fa");
pub const KSPROPSETID_AudioModule = Guid.initString("c034fdb0-ff75-47c8-aa3c-ee46716b50c6");
pub const KSNOTIFICATIONID_AudioModule = Guid.initString("9c2220f0-d9a6-4d5c-a036-573857fd50d2");
pub const CLSID_Proxy = Guid.initString("17cca71b-ecd7-11d0-b908-00a0c9223196");
