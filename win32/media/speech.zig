...
pub const SpNotifyTranslator = Guid.initString("e2ae5372-5d40-11d2-960e-00c04f8ee628");
pub const SpObjectTokenCategory = Guid.initString("a910187f-0c7a-45ac-92cc-59edafb77b53");
pub const SpObjectToken = Guid.initString("ef411752-3736-4cb4-9c8c-8ef4ccb58efe");
pub const SpResourceManager = Guid.initString("96749373-3391-11d2-9ee3-00c04f797396");
pub const SpStreamFormatConverter = Guid.initString("7013943a-e2ec-11d2-a086-00c04f8ef9b5");
pub const SpMMAudioEnum = Guid.initString("ab1890a0-e91f-11d2-bb91-00c04f8ee6c0");
pub const SpMMAudioIn = Guid.initString("cf3d2e50-53f2-11d2-960c-00c04f8ee628");
pub const SpMMAudioOut = Guid.initString("a8c680eb-3d32-11d2-9ee7-00c04f797396");
pub const SpStream = Guid.initString("715d9c59-4442-11d2-9605-00c04f8ee628");
pub const SpVoice = Guid.initString("96749377-3391-11d2-9ee3-00c04f797396");
pub const SpSharedRecoContext = Guid.initString("47206204-5eca-11d2-960f-00c04f8ee628");
pub const SpInprocRecognizer = Guid.initString("41b89b6b-9399-11d2-9623-00c04f8ee628");
pub const SpSharedRecognizer = Guid.initString("3bee4890-4fe9-4a37-8c1e-5e7e12791c1f");
pub const SpLexicon = Guid.initString("0655e396-25d0-11d3-9c26-00c04f8ef87c");
pub const SpUnCompressedLexicon = Guid.initString("c9e37c15-df92-4727-85d6-72e5eeb6995a");
pub const SpCompressedLexicon = Guid.initString("90903716-2f42-11d3-9c26-00c04f8ef87c");
pub const SpShortcut = Guid.initString("0d722f1a-9fcf-4e62-96d8-6df8f01a26aa");
pub const SpPhoneConverter = Guid.initString("9185f743-1143-4c28-86b5-bff14f20e5c8");
pub const SpPhoneticAlphabetConverter = Guid.initString("4f414126-dfe3-4629-99ee-797978317ead");
pub const SpNullPhoneConverter = Guid.initString("455f24e9-7396-4a16-9715-7c0fdbe3efe3");
pub const SpTextSelectionInformation = Guid.initString("0f92030a-cbfd-4ab8-a164-ff5985547ff6");
pub const SpPhraseInfoBuilder = Guid.initString("c23fc28d-c55f-4720-8b32-91f73c2bd5d1");
pub const SpAudioFormat = Guid.initString("9ef96870-e160-4792-820d-48cf0649e4ec");
pub const SpWaveFormatEx = Guid.initString("c79a574c-63be-44b9-801f-283f87f898be");
pub const SpInProcRecoContext = Guid.initString("73ad6842-ace0-45e8-a4dd-8795881a2c2a");
pub const SpCustomStream = Guid.initString("8dbef13f-1948-4aa8-8cf0-048eebed95d8");
pub const SpFileStream = Guid.initString("947812b3-2ae1-4644-ba86-9e90ded7ec91");
pub const SpMemoryStream = Guid.initString("5fb7ef7d-dff4-468a-b6b7-2fcbd188f994");
