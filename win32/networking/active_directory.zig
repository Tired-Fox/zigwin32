...
pub const PropertyEntry = Guid.initString("72d3edc2-a4c4-11d0-8533-00c04fd8d503");
pub const PropertyValue = Guid.initString("7b9e38b0-a97c-11d0-8534-00c04fd8d503");
pub const AccessControlEntry = Guid.initString("b75ac000-9bdd-11d0-852c-00c04fd8d503");
pub const AccessControlList = Guid.initString("b85ea052-9bdd-11d0-852c-00c04fd8d503");
pub const SecurityDescriptor = Guid.initString("b958f73c-9bdd-11d0-852c-00c04fd8d503");
pub const LargeInteger = Guid.initString("927971f5-0939-11d1-8be1-00c04fd8d503");
pub const NameTranslate = Guid.initString("274fae1f-3626-11d1-a3a4-00c04fb950dc");
pub const CaseIgnoreList = Guid.initString("15f88a55-4680-11d1-a3b4-00c04fb950dc");
pub const FaxNumber = Guid.initString("a5062215-4681-11d1-a3b4-00c04fb950dc");
pub const NetAddress = Guid.initString("b0b71247-4080-11d1-a3ac-00c04fb950dc");
pub const OctetList = Guid.initString("1241400f-4680-11d1-a3b4-00c04fb950dc");
pub const Email = Guid.initString("8f92a857-478e-11d1-a3b4-00c04fb950dc");
pub const Path = Guid.initString("b2538919-4080-11d1-a3ac-00c04fb950dc");
pub const ReplicaPointer = Guid.initString("f5d1badf-4080-11d1-a3ac-00c04fb950dc");
pub const Timestamp = Guid.initString("b2bed2eb-4080-11d1-a3ac-00c04fb950dc");
pub const PostalAddress = Guid.initString("0a75afcd-4680-11d1-a3b4-00c04fb950dc");
pub const BackLink = Guid.initString("fcbf906f-4080-11d1-a3ac-00c04fb950dc");
pub const TypedName = Guid.initString("b33143cb-4080-11d1-a3ac-00c04fb950dc");
pub const Hold = Guid.initString("b3ad3e13-4080-11d1-a3ac-00c04fb950dc");
pub const Pathname = Guid.initString("080d0d78-f421-11d0-a36e-00c04fb950dc");
pub const ADSystemInfo = Guid.initString("50b6327f-afd1-11d2-9cb9-0000f87a369e");
pub const WinNTSystemInfo = Guid.initString("66182ec4-afd1-11d2-9cb9-0000f87a369e");
pub const DNWithBinary = Guid.initString("7e99c0a3-f935-11d2-ba96-00c04fb6d0d1");
pub const DNWithString = Guid.initString("334857cc-f934-11d2-ba96-00c04fb6d0d1");
pub const ADsSecurityUtility = Guid.initString("f270c64a-ffb8-4ae4-85fe-3a75e5347966");
