...
pub const RdcLibrary = Guid.initString("96236a85-9dbc-11da-9e3f-0011114ae311");
pub const RdcGeneratorParameters = Guid.initString("96236a86-9dbc-11da-9e3f-0011114ae311");
pub const RdcGeneratorFilterMaxParameters = Guid.initString("96236a87-9dbc-11da-9e3f-0011114ae311");
pub const RdcGenerator = Guid.initString("96236a88-9dbc-11da-9e3f-0011114ae311");
pub const RdcFileReader = Guid.initString("96236a89-9dbc-11da-9e3f-0011114ae311");
pub const RdcSignatureReader = Guid.initString("96236a8a-9dbc-11da-9e3f-0011114ae311");
pub const RdcComparator = Guid.initString("96236a8b-9dbc-11da-9e3f-0011114ae311");
pub const SimilarityReportProgress = Guid.initString("96236a8d-9dbc-11da-9e3f-0011114ae311");
pub const SimilarityTableDumpState = Guid.initString("96236a8e-9dbc-11da-9e3f-0011114ae311");
pub const SimilarityTraitsTable = Guid.initString("96236a8f-9dbc-11da-9e3f-0011114ae311");
pub const SimilarityFileIdTable = Guid.initString("96236a90-9dbc-11da-9e3f-0011114ae311");
pub const Similarity = Guid.initString("96236a91-9dbc-11da-9e3f-0011114ae311");
pub const RdcSimilarityGenerator = Guid.initString("96236a92-9dbc-11da-9e3f-0011114ae311");
pub const FindSimilarResults = Guid.initString("96236a93-9dbc-11da-9e3f-0011114ae311");
pub const SimilarityTraitsMapping = Guid.initString("96236a94-9dbc-11da-9e3f-0011114ae311");
pub const SimilarityTraitsMappedView = Guid.initString("96236a95-9dbc-11da-9e3f-0011114ae311");
