...
//--------------------------------------------------------------------------------
// Section: Constants (2852)
//--------------------------------------------------------------------------------
pub const CERT_COMPARE_SHIFT = @as(i32, 16);
pub const CCertSrvSetupKeyInformation = Guid.initString("38373906-5433-4633-b0fb-29b7e78262e1");
pub const CCertSrvSetup = Guid.initString("961f180f-f55c-413d-a9b3-7d2af4d8e42f");
pub const CMSCEPSetup = Guid.initString("aa4f5c02-8e7c-49c4-94fa-67a5cc5eadb4");
pub const CCertificateEnrollmentServerSetup = Guid.initString("9902f3bc-88af-4cf8-ae62-7140531552b6");
pub const CCertificateEnrollmentPolicyServerSetup = Guid.initString("afe2fa32-41b1-459d-a5de-49add8a72182");
