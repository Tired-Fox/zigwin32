...
pub const TpmVirtualSmartCardManager = Guid.initString("16a18e86-7f6e-4c20-ad89-4ffc0db7a96a");
pub const RemoteTpmVirtualSmartCardManager = Guid.initString("152ea2a8-70dc-4c59-8b2a-32aa3ca0dcac");
