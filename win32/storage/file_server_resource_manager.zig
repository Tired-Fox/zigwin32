...
pub const FsrmSetting = Guid.initString("f556d708-6d4d-4594-9c61-7dbb0dae2a46");
pub const FsrmPathMapper = Guid.initString("f3be42bd-8ac2-409e-bbd8-faf9b6b41feb");
pub const FsrmExportImport = Guid.initString("1482dc37-fae9-4787-9025-8ce4e024ab56");
pub const FsrmQuotaManager = Guid.initString("90dcab7f-347c-4bfc-b543-540326305fbe");
pub const FsrmQuotaTemplateManager = Guid.initString("97d3d443-251c-4337-81e7-b32e8f4ee65e");
pub const FsrmFileGroupManager = Guid.initString("8f1363f6-656f-4496-9226-13aecbd7718f");
pub const FsrmFileScreenManager = Guid.initString("95941183-db53-4c5f-b37b-7d0921cf9dc7");
pub const FsrmFileScreenTemplateManager = Guid.initString("243111df-e474-46aa-a054-eaa33edc292a");
pub const FsrmReportManager = Guid.initString("0058ef37-aa66-4c48-bd5b-2fce432ab0c8");
pub const FsrmReportScheduler = Guid.initString("ea25f1b8-1b8d-4290-8ee8-e17c12c2fe20");
pub const FsrmFileManagementJobManager = Guid.initString("eb18f9b2-4c3a-4321-b203-205120cff614");
pub const FsrmClassificationManager = Guid.initString("b15c0e47-c391-45b9-95c8-eb596c853f3a");
pub const FsrmPipelineModuleConnector = Guid.initString("c7643375-1eb5-44de-a062-623547d933bc");
pub const AdSyncTask = Guid.initString("2ae64751-b728-4d6b-97a0-b2da2e7d2a3b");
pub const FsrmAccessDeniedRemediationClient = Guid.initString("100b4fc8-74c1-470f-b1b7-dd7b6bae79bd");
