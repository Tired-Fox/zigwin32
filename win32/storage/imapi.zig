...
pub const MsftDiscMaster2 = Guid.initString("2735412e-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftDiscRecorder2 = Guid.initString("2735412d-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftWriteEngine2 = Guid.initString("2735412c-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftDiscFormat2Erase = Guid.initString("2735412b-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftDiscFormat2Data = Guid.initString("2735412a-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftDiscFormat2TrackAtOnce = Guid.initString("27354129-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftDiscFormat2RawCD = Guid.initString("27354128-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftStreamZero = Guid.initString("27354127-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftStreamPrng001 = Guid.initString("27354126-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftStreamConcatenate = Guid.initString("27354125-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftStreamInterleave = Guid.initString("27354124-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftWriteSpeedDescriptor = Guid.initString("27354123-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftMultisessionSequential = Guid.initString("27354122-7f64-5b0f-8f00-5d77afbe261e");
pub const MsftMultisessionRandomWrite = Guid.initString("b507ca24-2204-11dd-966a-001aa01bbc58");
pub const MsftRawCDImageCreator = Guid.initString("25983561-9d65-49ce-b335-40630d901227");
pub const BootOptions = Guid.initString("2c941fce-975b-59be-a960-9a2a262853a5");
pub const FsiStream = Guid.initString("2c941fcd-975b-59be-a960-9a2a262853a5");
pub const FileSystemImageResult = Guid.initString("2c941fcc-975b-59be-a960-9a2a262853a5");
pub const ProgressItem = Guid.initString("2c941fcb-975b-59be-a960-9a2a262853a5");
pub const EnumProgressItems = Guid.initString("2c941fca-975b-59be-a960-9a2a262853a5");
pub const ProgressItems = Guid.initString("2c941fc9-975b-59be-a960-9a2a262853a5");
pub const FsiDirectoryItem = Guid.initString("2c941fc8-975b-59be-a960-9a2a262853a5");
pub const FsiFileItem = Guid.initString("2c941fc7-975b-59be-a960-9a2a262853a5");
pub const EnumFsiItems = Guid.initString("2c941fc6-975b-59be-a960-9a2a262853a5");
pub const FsiNamedStreams = Guid.initString("c6b6f8ed-6d19-44b4-b539-b159b793a32d");
pub const MsftFileSystemImage = Guid.initString("2c941fc5-975b-59be-a960-9a2a262853a5");
pub const MsftIsoImageManager = Guid.initString("ceee3b62-8f56-4056-869b-ef16917e3efc");
pub const BlockRange = Guid.initString("b507ca27-2204-11dd-966a-001aa01bbc58");
pub const BlockRangeList = Guid.initString("b507ca28-2204-11dd-966a-001aa01bbc58");
pub const MSDiscRecorderObj = Guid.initString("520cca61-51a5-11d3-9144-00104ba11c5e");
pub const MSDiscMasterObj = Guid.initString("520cca63-51a5-11d3-9144-00104ba11c5e");
pub const MSEnumDiscRecordersObj = Guid.initString("8a03567a-63cb-4ba8-baf6-52119816d1ef");
pub const tagIMMPID_MP_STRUCT = Guid.initString("13384cf0-b3c4-11d1-aa92-00aa006bc80b");
pub const tagIMMPID_RP_STRUCT = Guid.initString("79e82048-d320-11d1-9ff4-00c04fa37348");
pub const tagIMMPID_MPV_STRUCT = Guid.initString("cbe69706-c9bd-11d1-9ff2-00c04fa37348");
pub const tagIMMPID_RPV_STRUCT = Guid.initString("79e82049-d320-11d1-9ff4-00c04fa37348");
pub const tagIMMPID_NMP_STRUCT = Guid.initString("7433a9aa-20e2-11d2-94d6-00c04fa379f1");
pub const tagIMMPID_CPV_STRUCT = Guid.initString("a2a76b2a-e52d-11d1-aa64-00c04fa35b82");
