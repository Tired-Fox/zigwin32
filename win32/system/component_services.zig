...
pub const SecurityIdentity = Guid.initString("ecabb0a5-7f19-11d2-978e-0000f8757e2a");
pub const SecurityCallers = Guid.initString("ecabb0a6-7f19-11d2-978e-0000f8757e2a");
pub const SecurityCallContext = Guid.initString("ecabb0a7-7f19-11d2-978e-0000f8757e2a");
pub const GetSecurityCallContextAppObject = Guid.initString("ecabb0a8-7f19-11d2-978e-0000f8757e2a");
pub const Dummy30040732 = Guid.initString("ecabb0a9-7f19-11d2-978e-0000f8757e2a");
pub const TransactionContext = Guid.initString("7999fc25-d3c6-11cf-acab-00a024a55aef");
pub const TransactionContextEx = Guid.initString("5cb66670-d3d4-11cf-acab-00a024a55aef");
pub const ByotServerEx = Guid.initString("ecabb0aa-7f19-11d2-978e-0000f8757e2a");
pub const CServiceConfig = Guid.initString("ecabb0c8-7f19-11d2-978e-0000f8757e2a");
pub const ServicePool = Guid.initString("ecabb0c9-7f19-11d2-978e-0000f8757e2a");
pub const ServicePoolConfig = Guid.initString("ecabb0ca-7f19-11d2-978e-0000f8757e2a");
pub const SharedProperty = Guid.initString("2a005c05-a5de-11cf-9e66-00aa00a3f464");
pub const SharedPropertyGroup = Guid.initString("2a005c0b-a5de-11cf-9e66-00aa00a3f464");
pub const SharedPropertyGroupManager = Guid.initString("2a005c11-a5de-11cf-9e66-00aa00a3f464");
pub const COMEvents = Guid.initString("ecabb0ab-7f19-11d2-978e-0000f8757e2a");
pub const CoMTSLocator = Guid.initString("ecabb0ac-7f19-11d2-978e-0000f8757e2a");
pub const MtsGrp = Guid.initString("4b2e958d-0393-11d1-b1ab-00aa00ba3258");
pub const ComServiceEvents = Guid.initString("ecabb0c3-7f19-11d2-978e-0000f8757e2a");
pub const ComSystemAppEventData = Guid.initString("ecabb0c6-7f19-11d2-978e-0000f8757e2a");
pub const CRMClerk = Guid.initString("ecabb0bd-7f19-11d2-978e-0000f8757e2a");
pub const CRMRecoveryClerk = Guid.initString("ecabb0be-7f19-11d2-978e-0000f8757e2a");
pub const LBEvents = Guid.initString("ecabb0c1-7f19-11d2-978e-0000f8757e2a");
pub const MessageMover = Guid.initString("ecabb0bf-7f19-11d2-978e-0000f8757e2a");
pub const DispenserManager = Guid.initString("ecabb0c0-7f19-11d2-978e-0000f8757e2a");
pub const PoolMgr = Guid.initString("ecabafb5-7f19-11d2-978e-0000f8757e2a");
pub const EventServer = Guid.initString("ecabafbc-7f19-11d2-978e-0000f8757e2a");
pub const TrackerServer = Guid.initString("ecabafb9-7f19-11d2-978e-0000f8757e2a");
pub const AppDomainHelper = Guid.initString("ef24f689-14f8-4d92-b4af-d7b1f0e70fd4");
pub const ClrAssemblyLocator = Guid.initString("458aa3b5-265a-4b75-bc05-9bea4630cf18");
pub const COMAdminCatalog = Guid.initString("f618c514-dfb8-11d1-a2cf-00805fc79235");
pub const COMAdminCatalogObject = Guid.initString("f618c515-dfb8-11d1-a2cf-00805fc79235");
pub const COMAdminCatalogCollection = Guid.initString("f618c516-dfb8-11d1-a2cf-00805fc79235");
