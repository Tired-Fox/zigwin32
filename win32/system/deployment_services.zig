...
pub const WdsTransportCacheable = Guid.initString("70590b16-f146-46bd-bd9d-4aaa90084bf5");
pub const WdsTransportCollection = Guid.initString("c7f18b09-391e-436e-b10b-c3ef46f2c34f");
pub const WdsTransportManager = Guid.initString("f21523f6-837c-4a58-af99-8a7e27f8ff59");
pub const WdsTransportServer = Guid.initString("ea19b643-4adf-4413-942c-14f379118760");
pub const WdsTransportSetupManager = Guid.initString("c7beeaad-9f04-4923-9f0c-fbf52bc7590f");
pub const WdsTransportConfigurationManager = Guid.initString("8743f674-904c-47ca-8512-35fe98f6b0ac");
pub const WdsTransportNamespaceManager = Guid.initString("f08cdb63-85de-4a28-a1a9-5ca3e7efda73");
pub const WdsTransportServicePolicy = Guid.initString("65aceadc-2f0b-4f43-9f4d-811865d8cead");
pub const WdsTransportDiagnosticsPolicy = Guid.initString("eb3333e1-a7ad-46f5-80d6-6b740204e509");
pub const WdsTransportMulticastSessionPolicy = Guid.initString("3c6bc3f4-6418-472a-b6f1-52d457195437");
pub const WdsTransportNamespace = Guid.initString("d8385768-0732-4ec1-95ea-16da581908a1");
pub const WdsTransportNamespaceAutoCast = Guid.initString("b091f5a8-6a99-478d-b23b-09e8fee04574");
pub const WdsTransportNamespaceScheduledCast = Guid.initString("badc1897-7025-44eb-9108-fb61c4055792");
pub const WdsTransportNamespaceScheduledCastManualStart = Guid.initString("d3e1a2aa-caac-460e-b98a-47f9f318a1fa");
pub const WdsTransportNamespaceScheduledCastAutoStart = Guid.initString("a1107052-122c-4b81-9b7c-386e6855383f");
pub const WdsTransportContent = Guid.initString("0a891fe7-4a3f-4c65-b6f2-1467619679ea");
pub const WdsTransportSession = Guid.initString("749ac4e0-67bc-4743-bfe5-cacb1f26f57f");
pub const WdsTransportClient = Guid.initString("66d2c5e9-0ff6-49ec-9733-dafb1e01df1c");
pub const WdsTransportTftpClient = Guid.initString("50343925-7c5c-4c8c-96c4-ad9fa5005fba");
pub const WdsTransportTftpManager = Guid.initString("c8e9dca2-3241-4e4d-b806-bc74019dfeda");
pub const WdsTransportContentProvider = Guid.initString("e0be741f-5a75-4eb9-8a2d-5e189b45f327");
