...
pub const SideShowSession = Guid.initString("e20543b9-f785-4ea2-981e-c4ffa76bbc7c");
pub const SideShowNotification = Guid.initString("0ce3e86f-d5cd-4525-a766-1abab1a752f5");
pub const SideShowKeyCollection = Guid.initString("dfbbdbf8-18de-49b8-83dc-ebc727c62d94");
pub const SideShowPropVariantCollection = Guid.initString("e640f415-539e-4923-96cd-5f093bc250cd");
