...
pub const MSMQQuery = Guid.initString("d7d6e073-dccd-11d0-aa4b-0060970debae");
pub const MSMQMessage = Guid.initString("d7d6e075-dccd-11d0-aa4b-0060970debae");
pub const MSMQQueue = Guid.initString("d7d6e079-dccd-11d0-aa4b-0060970debae");
pub const MSMQEvent = Guid.initString("d7d6e07a-dccd-11d0-aa4b-0060970debae");
pub const MSMQQueueInfo = Guid.initString("d7d6e07c-dccd-11d0-aa4b-0060970debae");
pub const MSMQQueueInfos = Guid.initString("d7d6e07e-dccd-11d0-aa4b-0060970debae");
pub const MSMQTransaction = Guid.initString("d7d6e080-dccd-11d0-aa4b-0060970debae");
pub const MSMQCoordinatedTransactionDispenser = Guid.initString("d7d6e082-dccd-11d0-aa4b-0060970debae");
pub const MSMQTransactionDispenser = Guid.initString("d7d6e084-dccd-11d0-aa4b-0060970debae");
pub const MSMQApplication = Guid.initString("d7d6e086-dccd-11d0-aa4b-0060970debae");
pub const MSMQDestination = Guid.initString("eba96b18-2168-11d3-898c-00e02c074f6b");
pub const MSMQCollection = Guid.initString("f72b9031-2f0c-43e8-924e-e6052cdc493f");
pub const MSMQManagement = Guid.initString("39ce96fe-f4c5-4484-a143-4c2d5d324229");
pub const MSMQOutgoingQueueManagement = Guid.initString("0188401c-247a-4fed-99c6-bf14119d7055");
pub const MSMQQueueManagement = Guid.initString("33b6d07e-f27d-42fa-b2d7-bf82e11e9374");
