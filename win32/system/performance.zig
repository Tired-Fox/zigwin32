...
pub const DataCollectorSet = Guid.initString("03837521-098b-11d8-9414-505054503030");
pub const TraceSession = Guid.initString("0383751c-098b-11d8-9414-505054503030");
pub const TraceSessionCollection = Guid.initString("03837530-098b-11d8-9414-505054503030");
pub const TraceDataProvider = Guid.initString("03837513-098b-11d8-9414-505054503030");
pub const TraceDataProviderCollection = Guid.initString("03837511-098b-11d8-9414-505054503030");
pub const DataCollectorSetCollection = Guid.initString("03837525-098b-11d8-9414-505054503030");
pub const LegacyDataCollectorSet = Guid.initString("03837526-098b-11d8-9414-505054503030");
pub const LegacyDataCollectorSetCollection = Guid.initString("03837527-098b-11d8-9414-505054503030");
pub const LegacyTraceSession = Guid.initString("03837528-098b-11d8-9414-505054503030");
pub const LegacyTraceSessionCollection = Guid.initString("03837529-098b-11d8-9414-505054503030");
pub const ServerDataCollectorSet = Guid.initString("03837531-098b-11d8-9414-505054503030");
pub const ServerDataCollectorSetCollection = Guid.initString("03837532-098b-11d8-9414-505054503030");
pub const SystemDataCollectorSet = Guid.initString("03837546-098b-11d8-9414-505054503030");
pub const SystemDataCollectorSetCollection = Guid.initString("03837547-098b-11d8-9414-505054503030");
pub const BootTraceSession = Guid.initString("03837538-098b-11d8-9414-505054503030");
pub const BootTraceSessionCollection = Guid.initString("03837539-098b-11d8-9414-505054503030");
pub const SystemMonitor = Guid.initString("c4d2d8e0-d1dd-11ce-940f-008029004347");
pub const CounterItem = Guid.initString("c4d2d8e0-d1dd-11ce-940f-008029004348");
pub const Counters = Guid.initString("b2b066d2-2aac-11cf-942f-008029004347");
pub const LogFileItem = Guid.initString("16ec5be8-df93-4237-94e4-9ee918111d71");
pub const LogFiles = Guid.initString("2735d9fd-f6b9-4f19-a5d9-e2d068584bc5");
pub const CounterItem2 = Guid.initString("43196c62-c31f-4ce3-a02e-79efe0f6a525");
pub const SystemMonitor2 = Guid.initString("7f30578c-5f38-4612-acfe-6ed04c7b7af8");
pub const AppearPropPage = Guid.initString("e49741e9-93a8-4ab1-8e96-bf4482282e9c");
pub const GeneralPropPage = Guid.initString("c3e5d3d2-1a03-11cf-942d-008029004347");
pub const GraphPropPage = Guid.initString("c3e5d3d3-1a03-11cf-942d-008029004347");
pub const SourcePropPage = Guid.initString("0cf32aa1-7571-11d0-93c4-00aa00a3ddea");
pub const CounterPropPage = Guid.initString("cf948561-ede8-11ce-941e-008029004347");
