...
pub const TSUserExInterfaces = Guid.initString("0910dd01-df8c-11d1-ae27-00c04fa35813");
pub const ADsTSUserEx = Guid.initString("e2e9cae6-1e7b-4b8e-babd-e9bf6292ac29");
pub const Workspace = Guid.initString("4f1dfca6-3aad-48e1-8406-4bc21a501d7c");
