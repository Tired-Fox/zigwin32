...
pub const GPM = Guid.initString("f5694708-88fe-4b35-babf-e56162d5fbc8");
pub const GPMDomain = Guid.initString("710901be-1050-4cb1-838a-c5cff259e183");
pub const GPMSitesContainer = Guid.initString("229f5c42-852c-4b30-945f-c522be9bd386");
pub const GPMBackupDir = Guid.initString("fce4a59d-0f21-4afa-b859-e6d0c62cd10c");
pub const GPMSOM = Guid.initString("32d93fac-450e-44cf-829c-8b22ff6bdae1");
pub const GPMSearchCriteria = Guid.initString("17aaca26-5ce0-44fa-8cc0-5259e6483566");
pub const GPMPermission = Guid.initString("5871a40a-e9c0-46ec-913e-944ef9225a94");
pub const GPMSecurityInfo = Guid.initString("547a5e8f-9162-4516-a4df-9ddb9686d846");
pub const GPMBackup = Guid.initString("ed1a54b8-5efa-482a-93c0-8ad86f0d68c3");
pub const GPMBackupCollection = Guid.initString("eb8f035b-70db-4a9f-9676-37c25994e9dc");
pub const GPMSOMCollection = Guid.initString("24c1f147-3720-4f5b-a9c3-06b4e4f931d2");
pub const GPMWMIFilter = Guid.initString("626745d8-0dea-4062-bf60-cfc5b1ca1286");
pub const GPMWMIFilterCollection = Guid.initString("74dc6d28-e820-47d6-a0b8-f08d93d7fa33");
pub const GPMRSOP = Guid.initString("489b0caf-9ec2-4eb7-91f5-b6f71d43da8c");
pub const GPMGPO = Guid.initString("d2ce2994-59b5-4064-b581-4d68486a16c4");
pub const GPMGPOCollection = Guid.initString("7a057325-832d-4de3-a41f-c780436a4e09");
pub const GPMGPOLink = Guid.initString("c1df9880-5303-42c6-8a3c-0488e1bf7364");
pub const GPMGPOLinksCollection = Guid.initString("f6ed581a-49a5-47e2-b771-fd8dc02b6259");
pub const GPMAsyncCancel = Guid.initString("372796a9-76ec-479d-ad6c-556318ed5f9d");
pub const GPMStatusMsgCollection = Guid.initString("2824e4be-4bcc-4cac-9e60-0e3ed7f12496");
pub const GPMStatusMessage = Guid.initString("4b77cc94-d255-409b-bc62-370881715a19");
pub const GPMTrustee = Guid.initString("c54a700d-19b6-4211-bcb0-e8e2475e471e");
pub const GPMClientSideExtension = Guid.initString("c1a2e70e-659c-4b1a-940b-f88b0af9c8a4");
pub const GPMCSECollection = Guid.initString("cf92b828-2d44-4b61-b10a-b327afd42da8");
pub const GPMConstants = Guid.initString("3855e880-cd9e-4d0c-9eaf-1579283a1888");
pub const GPMResult = Guid.initString("92101ac0-9287-4206-a3b2-4bdb73d225f6");
pub const GPMMapEntryCollection = Guid.initString("0cf75d5b-a3a1-4c55-b4fe-9e149c41f66d");
pub const GPMMapEntry = Guid.initString("8c975253-5431-4471-b35d-0626c928258a");
pub const GPMMigrationTable = Guid.initString("55af4043-2a06-4f72-abef-631b44079c76");
pub const GPMBackupDirEx = Guid.initString("e8c0988a-cf03-4c5b-8be2-2aa9ad32aada");
pub const GPMStarterGPOBackupCollection = Guid.initString("e75ea59d-1aeb-4cb5-a78a-281daa582406");
pub const GPMStarterGPOBackup = Guid.initString("389e400a-d8ef-455b-a861-5f9ca34a6a02");
pub const GPMTemplate = Guid.initString("ecf1d454-71da-4e2f-a8c0-8185465911d9");
pub const GPMStarterGPOCollection = Guid.initString("82f8aa8b-49ba-43b2-956e-3397f9b94c3a");
