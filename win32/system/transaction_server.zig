...
// Section: Constants (7)
//--------------------------------------------------------------------------------
pub const Catalog = Guid.initString("6eb22881-8a19-11d0-81b6-00a0c9231c29");
pub const CatalogObject = Guid.initString("6eb22882-8a19-11d0-81b6-00a0c9231c29");
pub const CatalogCollection = Guid.initString("6eb22883-8a19-11d0-81b6-00a0c9231c29");
pub const ComponentUtil = Guid.initString("6eb22884-8a19-11d0-81b6-00a0c9231c29");
pub const PackageUtil = Guid.initString("6eb22885-8a19-11d0-81b6-00a0c9231c29");
pub const RemoteComponentUtil = Guid.initString("6eb22886-8a19-11d0-81b6-00a0c9231c29");
pub const RoleAssociationUtil = Guid.initString("6eb22887-8a19-11d0-81b6-00a0c9231c29");
