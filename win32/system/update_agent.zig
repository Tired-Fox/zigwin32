...
pub const StringCollection = Guid.initString("72c97d74-7c3b-40ae-b77d-abdb22eba6fb");
pub const UpdateSearcher = Guid.initString("b699e5e8-67ff-4177-88b0-3684a3388bfb");
pub const WebProxy = Guid.initString("650503cf-9108-4ddc-a2ce-6c2341e1c582");
pub const SystemInformation = Guid.initString("c01b9ba0-bea7-41ba-b604-d0a36f469133");
pub const WindowsUpdateAgentInfo = Guid.initString("c2e88c2f-6f5b-4aaa-894b-55c847ad3a2d");
pub const AutomaticUpdates = Guid.initString("bfe18e9c-6d87-4450-b37c-e02f0b373803");
pub const UpdateCollection = Guid.initString("13639463-00db-4646-803d-528026140d88");
pub const UpdateDownloader = Guid.initString("5baf654a-5a07-4264-a255-9ff54c7151e7");
pub const UpdateInstaller = Guid.initString("d2e0fe7f-d23e-48e1-93c0-6fa8cc346474");
pub const UpdateSession = Guid.initString("4cb43d7f-7eee-4906-8698-60da1c38f2fe");
pub const UpdateServiceManager = Guid.initString("f8d253d9-89a4-4daa-87b6-1168369f0b21");
pub const InstallationAgent = Guid.initString("317e92fc-1679-46fd-a0b5-f08914dd8623");
