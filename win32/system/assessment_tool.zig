...
// Section: Constants (6)
//--------------------------------------------------------------------------------
pub const CInitiateWinSAT = Guid.initString("489331dc-f5e0-4528-9fda-45331bf4a571");
pub const CQueryWinSAT = Guid.initString("f3bdfad3-f276-49e9-9b17-c474f48f0764");
pub const CQueryAllWinSAT = Guid.initString("05df8d13-c355-47f4-a11e-851b338cefb8");
pub const CProvideWinSATVisuals = Guid.initString("9f377d7e-e551-44f8-9f94-9db392b03b7b");
pub const CAccessiblityWinSAT = Guid.initString("6e18f9c6-a3eb-495a-89b7-956482e19f7a");
pub const CQueryOEMWinSATCustomization = Guid.initString("c47a41b7-b729-424f-9af9-5cb3934f2dfa");
