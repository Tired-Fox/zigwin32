...
pub const GameExplorer = Guid.initString("9a5ea990-3034-4d6f-9128-01f3c61022bc");
pub const GameStatistics = Guid.initString("dbc85a2c-c0dc-4961-b6e2-d28b62c11ad4");
pub const XblIdpAuthManager = Guid.initString("ce23534b-56d8-4978-86a2-7ee570640468");
pub const XblIdpAuthTokenResult = Guid.initString("9f493441-744a-410c-ae2b-9a22f7c7731f");
