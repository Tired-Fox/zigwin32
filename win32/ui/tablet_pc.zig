...
pub const InkDisp = Guid.initString("937c1a34-151d-4610-9ca6-a8cc9bdb5d83");
pub const InkOverlay = Guid.initString("65d00646-cde3-4a88-9163-6769f0f1a97d");
pub const InkPicture = Guid.initString("04a1e553-fe36-4fde-865e-344194e69424");
pub const InkCollector = Guid.initString("43fb1553-ad74-4ee8-88e4-3e6daac915db");
pub const InkDrawingAttributes = Guid.initString("d8bf32a2-05a5-44c3-b3aa-5e80ac7d2576");
pub const InkRectangle = Guid.initString("43b07326-aae0-4b62-a83d-5fd768b7353c");
pub const InkRenderer = Guid.initString("9c1cc6e4-d7eb-4eeb-9091-15a7c8791ed9");
pub const InkTransform = Guid.initString("e3d5d93c-1663-4a78-a1a7-22375dfebaee");
pub const InkRecognizers = Guid.initString("9fd4e808-f6e6-4e65-98d3-aa39054c1255");
pub const InkRecognizerContext = Guid.initString("aac46a37-9229-4fc0-8cce-4497569bf4d1");
pub const InkRecognizerGuide = Guid.initString("8770d941-a63a-4671-a375-2855a18eba73");
pub const InkTablets = Guid.initString("6e4fcb12-510a-4d40-9304-1da10ae9147c");
pub const InkWordList = Guid.initString("9de85094-f71f-44f1-8471-15a2fa76fcf3");
pub const InkStrokes = Guid.initString("48f491bc-240e-4860-b079-a1e94d3d2c86");
pub const Ink = Guid.initString("13de4a42-8d21-4c8e-bf9c-8f69cb068fca");
pub const SketchInk = Guid.initString("f0291081-e87c-4e07-97da-a0a03761e586");
pub const InkDivider = Guid.initString("8854f6a0-4683-4ae7-9191-752fe64612c3");
pub const HandwrittenTextInsertion = Guid.initString("9f074ee2-e6e9-4d8a-a047-eb5b5c3c55da");
pub const PenInputPanel = Guid.initString("f744e496-1b5a-489e-81dc-fbd7ac6298a8");
pub const TextInputPanel = Guid.initString("f9b189d7-228b-4f2b-8650-b97f59e02c8c");
pub const PenInputPanel_Internal = Guid.initString("802b1fb9-056b-4720-b0cc-80d23b71171e");
pub const InkEdit = Guid.initString("e5ca59f5-57c4-4dd8-9bd6-1deeedd27af4");
pub const MathInputControl = Guid.initString("c561816c-14d8-4090-830c-98d994b21c7b");
pub const RealTimeStylus = Guid.initString("e26b366d-f998-43ce-836f-cb6d904432b0");
pub const DynamicRenderer = Guid.initString("ecd32aea-746f-4dcb-bf68-082757faff18");
pub const GestureRecognizer = Guid.initString("ea30c654-c62c-441f-ac00-95f9a196782c");
pub const StrokeBuilder = Guid.initString("e810cee7-6e51-4cb0-aa3a-0b985b70daf7");
pub const TipAutoCompleteClient = Guid.initString("807c1e6c-1d00-453f-b920-b61bb7cdd997");
